...
namespace WebGAP.Models
{
    ...
    public class ApplicationUser : IdentityUser
    {
       ...
       public string UserFullName { get; internal set; }
        ...
        public int CenterID { get; internal set; }
        public int UserActive { get; internal set; }
        public int PIID { get; internal set; }
...
namespace WebGAP
{
    public static class IdentityHelper
    {
        ...
        public static string GetResetPasswordRedirectUrl(string code, HttpRequest request)
        {
            ...
            return new Uri(newUri, absoluteUri).AbsoluteUri.ToString();
        }
