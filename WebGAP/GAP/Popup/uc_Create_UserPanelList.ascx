<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Create_UserPanelList.ascx.cs" Inherits="WebGAP.GAP.uc.uc_Create_UserPanelList" %>
<style>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <%-- <a id="B99" title="<p style=&quot;text-align: left&quot;><b>Current genome builds:</b> <br><b>-Homo sapiens:</b>   hg19 (GRCh37)<br><b>-Mus musculus:</b>   mm10 (GRCm38)<br><b>-Caenorhabditis elegans:</b>   ce11 (WBcel235)<br><b>-Rattus norvegicus:</b>   rn5 (Rnor_5.0)<br><b>-Drosophila melanogaster:</b>   dm3 (BDGP5)<br><b>-Danio rerio:</b>   danRer7 (Zv9)</p>"
                                                                href="#">
                                                ...
                                                <asp:Panel ID="Pnl_TG_Chr" runat="server">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 20px;">
                                                                <telerik:RadComboBox ID="CB_Chromosome" runat="server" Skin="Metro" Label="Choose Chr:" DataSourceID="SDS_Population_Chromosome"
                                                            ...
                                                            <td>
                                                                <telerik:RadComboBox ID="RC_TraG_ChrBand" runat="server" Label="Choose band:" Skin="Metro"
                                                                    Width="120px" AutoPostBack="false" EnableLoadOnDemand="true" ShowMoreResultsBox="true"
                                                                    OnItemsRequested="RC_TraG_ChrBand_ItemsRequested" EnableVirtualScrolling="true"
                                                                    Enabled="true" OnClientDropDownOpening="RC_TraG_ChrBand_DropDownOpening">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td style="width: 10px; text-align: center">
                                                                <i class="fa fa-ellipsis-v"></i>
...
<%--                                                <telerik:RadComboBox ID="RC_TrainingGen_GOTerms" runat="server" Skin="Metro" Label="Choose a GO term:" CssClass="p-l-20"
                                                    Width="400px" Height="200px" AutoPostBack="true" EnableLoadOnDemand="True" ShowMoreResultsBox="false" Filter="Contains"
                                                    EnableVirtualScrolling="true" OnItemsRequested="RC_TrainingGen_GOTerms_ItemsRequested"
                                                    OnClientDropDownOpening="RC_TrainingGen_GOTerms_DropDownOpening">
                                                </telerik:RadComboBox>--%>
                                            </td>
                                            <td style="width: 10px; text-align: center">
                                                <i class="fa fa-ellipsis-v"></i>
                                ...
                                <telerik:RadPageView runat="server" ID="RPW_P4" CssClass="corporatePageView">
                                    <table style="background: #eaeaea; width: 100%; border-bottom: 1px solid #ddd">
                                        ...
                                        <tr>
                                            <td>
                                             <%--   <telerik:RadComboBox ID="RC_TrainingGen_OMIMTerms" runat="server" Skin="Metro" CssClass="p-l-20" Filter="Contains"
                                                    Label="Choose a OMIM:" Width="400px" Height="200px" AutoPostBack="true" EnableLoadOnDemand="True"  DataTextField="term" DataValueField="omimId"
                                        ...
                                        <%--OnClientDropDownOpening="RC_Gene_DropDownOpening"--%>
                                            ...
                                            <td>
                                                <telerik:RadButton ID="Btn_Add_TrainingGen_OMIMTerms" runat="server" Text="ADD" AutoPostBack="true" OnClick="Btn_Add_TrainingGen_OMIMTerms_Click" Skin="Material"
                        ...
                        <div class="row col-12 pt-1">
                            ...
                            <telerik:RadListBox ID="RLB_TrainingGenes" runat="server" CheckBoxes="false" ShowCheckAll="false"
                                Width="100%" Height="300px" EmptyMessage="No items added" ViewStateMode="Enabled" SelectionMode="Multiple"
                                OnClientLoad="RLB_TrainingGenes_Load">
                                <HeaderTemplate>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadButton runat="server" ID="RB_Submit" Text="SUBMIT" AutoPostBack="true" OnClientClick="Btn_Can_Finish_Clicked()" Skin="Material"
                        CssClass="btn_finish" OnClick="RB_Submit_Click" ValidationGroup="validName">
                        <%--CssClass="btn btn_outline-info"--%>
...
<telerik:RadListBox ID="Radlisbox_Sample_TrainingGene" runat="server" CheckBoxes="false"
...
<asp:SqlDataSource ID="SDS_Population_Chromosome" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>" 
    ...
    <SelectParameters>
        <asp:SessionParameter Name="RefBuild" SessionField="RefBuild" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
