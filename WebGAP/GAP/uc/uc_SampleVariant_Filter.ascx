<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_SampleVariant_Filter.ascx.cs" Inherits="WebGAP.GAP.uc.uc_SampleVariant_Filter" ValidateRequestMode="Disabled" %>
...
<style>
    ...
    .RadListBox .rlbDisabled .rlbIconDelete {
        margin-top: -7px !important;
        padding: 2px 0 0 0 !important;
    }

    .rlbButtonAreaBottom.rlbDisabled {
        margin-left: 0 !important;
        margin-top: 0 !important;
    }

    .RLB_Filter .rlbDisabled {
        margin-top: 6px !important;
    }

        .RLB_Filter .rlbDisabled .rlbIconDelete, .RLB_Filter .rlbIconDelete {
    ...
    .RLB_SavedFilter .rlbDisabled {
        margin-top: 5px !important;
        font-size: 11px !important;
    }
    .RLB_SavedFilter .rlbDisabled .rlbIconDelete, .RLB_SavedFilter .rlbIconDelete {
...
<telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
    <AjaxSettings>
        ...
        <telerik:AjaxSetting AjaxControlID="RBAddScores">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="RBAddScores" />
                <telerik:AjaxUpdatedControl ControlID="lbl_err_score" />
                <telerik:AjaxUpdatedControl ControlID="RLB_Filter" LoadingPanelID="RadAjaxLoadingPanel1" />
                <telerik:AjaxUpdatedControl ControlID="RBAddSelectedItem" />
            </UpdatedControls>
        </telerik:AjaxSetting>
        ...
        <telerik:AjaxSetting AjaxControlID="RBAddPanelList">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="lbl_err_panel" />
        ...
        <telerik:AjaxSetting AjaxControlID="RDD_FilterSet">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="PanelOrgChartPanel" />
            </UpdatedControls>
        </telerik:AjaxSetting>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12">
        <h3 class="content-header-title">
            <asp:Label runat="server" ID="lbl_sampleID" Text=""></asp:Label>
        </h3>
        <br />
    </div>
...
<div class="demo-container gray-bg" id="decorationZone" style="width: 45%; float: left">
    ...
    <fieldset>
        ...
        <table style="width: 100%" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 85%">
                    <telerik:RadComboBox CssClass="btn-sm rddl_filter" ID="RDD_FilterSet" runat="server" Height="200px" Width="100%" AutoPostBack="true"
                        EmptyMessage="Select your filter set" HighlightTemplatedItems="true" EnableLoadOnDemand="true" DropDownCssClass="RDD_FilterSet"
                ...
                <td style="width: 15%; text-align: right; padding-right: 13px">
                    <telerik:RadButton runat="server" OnClick="Del_RDD_FilterSet_Click" ID="Del_RDD_FilterSet" AutoPostBack="true" Text="delete" Skin="Material"
                        RenderMode="Lightweight" Font-Size="Small" Icon-PrimaryIconLeft="8px" Icon-PrimaryIconTop="12px" Width="93px" CssClass="delBtn">
                                ...
                                <telerik:RadPageView runat="server" ID="RPV_NewFilter">
                                    <table class="tbl-container" runat="server" style="width: 100%; margin: 0 auto;">
                                        <tbody>
                                            ...
                                            <%--<tr>
                                                    <td style="padding: 10px 15px 10px 15px;">Type:                               
                                                    </td>
                                                    <td style="padding: 10px 15px 10px 15px;">Private<input id="rdio_private" runat="server" name="filterItem" type="radio" value="1" />
                                                        Public<input id="rdio_public" runat="server" name="filterItem" type="radio" value="0" />
                                                    </td>
                                                </tr>--%>
                                            <tr>
            ...
            <telerik:RadMultiPage ID="RadMultiPage_DataHolder" runat="server" CssClass="innerMultiPage RMP_filter" SelectedIndex="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddAcmgRules" runat="server" ForeColor="White"
                                    Value="acmg" ID="RBAddAcmg" CausesValidation="false" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                                <%--<asp:HiddenField ID="hdnSelectedacmg" runat="server" ClientIDMode="Static" />--%>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td colspan="5" style="padding-top: 15px">
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddFreq" runat="server" ForeColor="White"
                                    Value="alleleFreq" ID="RBAddAlleleFreq" CausesValidation="false" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                    </table>
                </telerik:RadPageView>
                <telerik:RadPageView ID="RadPageView3" runat="server">
                    <table class="tbl-filter-container">
                        ...
                        <tr>
                            <td>
                                <telerik:RadNumericTextBox Width="90%" CssClass="form-control" MinValue="-1" MaxValue="1" runat="server" ID="siftSFrom" EmptyMessage="eq.0.01580">
                                    <NumberFormat DecimalDigits="10" AllowRounding="false" />
                            ...
                            <td style="width: 55%">
                                <telerik:RadComboBox RenderMode="Classic" ID="RCB_Scores" runat="server" Height="190px" Width="100%" Font-Size="12px"
                                    DropDownCssClass="multipleRowsColumns" DropDownWidth="400px" DataSourceID="SDS_Filter_Tab_Scores" ToolTip="Description" DataTextField="Description" DataValueField="Field" />
                            </td>
                            <td>
                                <div class="conditionDiv">=></div>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox Width="100%" CssClass="form-control" MinValue="-1" MaxValue="1" runat="server" ID="siftSTo" EmptyMessage="eq.0.0377">
                                    <NumberFormat DecimalDigits="10" AllowRounding="false" />
                                </telerik:RadNumericTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5" style="padding-top: 15px">
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddScore" runat="server" ForeColor="White"
                                    Value="scores" ID="RBAddScores" CausesValidation="false" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5" style="padding-top: 15px">
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddPapipred" runat="server" ForeColor="White"
                                    Value="Papipred" ID="RBAddPapipred" CausesValidation="false" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                            ...
                            <td colspan="5">
                                <div style="font-size: 12px; margin-top: 5px; padding-top: 11px; padding-bottom: 11px;">
                                    <div class="custom-control custom-checkbox" style="border-bottom: 1px solid #eaeaea">
                                        ...
                                        <label class="custom-control-label" for="D">D (Damaging)</label>
                                    </div>
                                    <div class="custom-control custom-checkbox" style="border-bottom: 1px solid #eaeaea">
                                        <input type="checkbox" class="custom-control-input" name="OtherPred" id="B" value="B">
                                        <label class="custom-control-label" for="B">B (Tolerated)</label>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5" style="padding-top: 15px">
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddOtherPred" runat="server" ForeColor="White"
                                    Value="OtherPred" ID="RBAddOtherPred" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                                <%--<asp:HiddenField ID="hdnSelectedOtherPred" runat="server" ClientIDMode="Static" />--%>
                                <hr />
                                <br />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBADDClinvar" runat="server" ForeColor="White"
                                    Value="clinvar" ID="RBADDClinvar" CausesValidation="false" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                    </table>
                </telerik:RadPageView>
                <telerik:RadPageView ID="RadPageView5" runat="server">
                    <table class="tbl-filter-container">
                        ...
                        <tr>
                            <td colspan="2">
                                <telerik:RadTextBox runat="server" ID="chr" EmptyMessage="Chromosome" CssClass="form-control" Width="100%"></telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <telerik:RadNumericTextBox runat="server" ID="start" EmptyMessage="Start" Type="Number" CssClass="form-control" Width="100%"></telerik:RadNumericTextBox>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox runat="server" ID="end" EmptyMessage="End" Type="Number" CssClass="form-control" Width="100%"></telerik:RadNumericTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddChrPos" runat="server" ForeColor="White"
                                    ID="RBAddChrPos" Value="ChrPos" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                    </table>
                </telerik:RadPageView>
                        ...
                        <tr>
                            <td>
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBZygosity" runat="server" ForeColor="White"
                                    ID="RBZygosity" Value="zygosity" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                    </table>
                </telerik:RadPageView>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBFunc" runat="server" ForeColor="White"
                                    ID="RBFunc" Value="func" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddGene" runat="server" ForeColor="White"
                                    ID="RBAddGene" Value="geneList" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />
                                <%--OnClientClicked="printSelectedGeneList"--%>
                                <br />
                                <br />
                            </td>
                        </tr>
                        ...
                        <tr style="background-color: white !important">
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm" runat="server" ForeColor="White"
                                    ID="RBAddGeneCount" Value="geneCount" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />

                                <telerik:RadButton ID="ShowResultGenePhenotype" RenderMode="Lightweight" CssClass="rb_geneCount" Skin="Material" runat="server"
                                    OnClick="ShowResultGenePhenotype_Click" Text="Show detail">
                ...
                <telerik:RadPageView ID="RadPageView10" runat="server">
                    <table class="tbl-filter-container">
                        <tr>
                            <td>
                                <h4>Panel List</h4>
                                <telerik:RadComboBox RenderMode="Classic" ID="RCB_PanelList" runat="server" Height="190px" Width="80%" Font-Size="13px" CssClass="float_left"
                                ...
                                <telerik:RadButton BorderStyle="Solid" BorderColor="#cacaca" BorderWidth="1px" runat="server" ID="RBAddPanelList" Width="18%"
                                    Height="33px" OnClick="RBAddPanelList_Click" CausesValidation="false" Text="Add below to preview" Skin="Metro" CssClass="float_right" />
                        ...
                        <tr>
                            <td>
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBADDGenePanelList" runat="server" ForeColor="White"
                                    ID="RBADDGenePanelList" Value="genePanelList" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 5px">
                ...
                <telerik:RadPageView ID="RadPageView11" runat="server">
                    <table class="tbl-filter-container">
                        ...
                        <tr>
                            <td colspan="5">
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm filterStats" runat="server" ForeColor="White"
                                    ID="RBAddFilterStat" Value="filterStats" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5" style="padding-top: 5px">
                        ...
                        <tr>
                            <td colspan="5">
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm mutationType" runat="server" ForeColor="White"
                                    ID="RBAddMutation" Value="mutationType" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5" style="padding-top: 5px">
                        ...
                        <tr>
                            <td style="width: 23%">
                                <telerik:RadNumericTextBox runat="server" ID="filterAFrom" MinValue="-1" CssClass="form-control" EmptyMessage="eq.0.03125"></telerik:RadNumericTextBox>
                            </td>
                            <td>
                                <div class="conditionDiv"><=</div>
                            </td>
                            ...
                            <td>
                                <telerik:RadNumericTextBox runat="server" ID="filterATo" MinValue="-1" CssClass="form-control" EmptyMessage="eq.0.03125"></telerik:RadNumericTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm filterAllele" runat="server" ForeColor="White"
                                    ID="RBAddFilterAllele" Value="filterAllele" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />
                            </td>
                        </tr>
                    </table>
                </telerik:RadPageView>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddInheritance" runat="server" ForeColor="White"
                                    Value="inheritance" ID="RBAddInheritance" CausesValidation="false" OnClick="RBAdd_Click" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                ...
                <telerik:RadPageView ID="RadPageView13" runat="server">
                    <table class="tbl-filter-container">
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBPenotype" runat="server" ForeColor="White"
                                    ID="RBAddPhenotype" Value="phenotype" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton BorderStyle="Solid" BorderColor="#cacaca" BorderWidth="1px" runat="server" ID="RBAddHPO" Width="8%"
                                    Height="33px" OnClick="RBAddHPO_Click" CausesValidation="false" Text="Add" Skin="Metro" CssClass="float_right padding_right_marginTop" />
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 15px">
                        ...
                        <tr>
                            <td>
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RBAddHPOToList" runat="server" ForeColor="White"
                                    ID="RBAddHPOToList" Value="hpo" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            <td style="padding-top: 5px">
                                <h5>From patient phenotype profile</h5>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr style="background-color: white !important">
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm" runat="server" ForeColor="White"
                                    ID="RBAddHPOCount" Value="HPOCount" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />

                                <telerik:RadButton ID="ShowResultHPOPhenotype" RenderMode="Lightweight" CssClass="rb_geneCount" Skin="Material" runat="server"
                                    OnClick="ShowResultHPOPhenotype_Click" Text="Show detail">
                                    <Icon PrimaryIconUrl="~/img/icon/icon_HPO_min.png" />
                                </telerik:RadButton>
                            </td>
                        </tr>
                    ...
                    <table class="tbl-filter-container">
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton BorderStyle="Solid" BorderColor="#cacaca" BorderWidth="1px" runat="server" ID="RBADDOMIM" Width="9%"
                                    Height="33px" OnClick="RBADDOMIM_Click" CausesValidation="false" Text="Add" Skin="Metro" CssClass="float_right" />
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 15px">
                        ...
                        <tr>
                            <td>
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm RB_ADDOMIM" runat="server" ForeColor="White"
                                    ID="RB_ADDOMIM" Value="omim" OnClick="RBAdd_Click" CausesValidation="false" Text="&#10003; Add to filter" />
                                <br />
                                <br />
                            </td>
                        </tr>
                        ...
                        <tr style="background-color: white !important">
                            <td>
                                ...
                                <telerik:RadButton CssClass="btn btn-info mr-1 ladda-button btn-sm" runat="server" ForeColor="White"
                                    ID="RBAddOMIMCount" Value="OmimCount" OnClick="RBAdd_Click" Text="&#10003; Add to filter" CausesValidation="false" />

                                <telerik:RadButton ID="ShowResultOmim" RenderMode="Lightweight" CssClass="rb_geneCount" Skin="Material" runat="server"
                                    OnClick="ShowResultOmim_Click" Text="Show detail">
                                    <Icon PrimaryIconUrl="~/img/icon/icon_HPO_min.png" />
                                </telerik:RadButton>
                            </td>
                        </tr>
