...
{
    public partial class uc_VariantQuery : System.Web.UI.UserControl
    {
        #region "CnnStr"{
        ...
        */
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lbl_sampleID.Text = Session["VariantDis_KeyForQuery"].ToString() + Session["VariantDis_ValueForQuery"].ToString() + " | " + Session["VariantDis_RefBuild"] + " | " + Session["VariantDis_SeqType"];
            ...
            {
                Session["baseCount"] = Session["VariantDis_TotalCount"];
        ...
        protected string getLocalID()
        {
            ...
            SqlCommand cmd = new SqlCommand("Sp_Filter_LocalID_Sel", conn);
            ...
            try
            {
                ...
                cmd.Parameters.Add("@SampleID", SqlDbType.BigInt);

                cmd.Parameters["@CenterID"].Value = Convert.ToInt32(Session["Current_CenterID"].ToString());
                cmd.Parameters["@SampleID"].Value = Convert.ToInt64(Session["SampleID_Filter"].ToString());
                ...
                {
                    LID = myDataTable.Rows[i]["LocalID"].ToString();
                }
        ...
        protected void AddNewFilter_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CnnStr))
            {
                using (SqlCommand myCMD = new SqlCommand("Sp_GAP_Add_New_Filter", con))
                {
                    ...
                    myCMD.Parameters.Add("@AnalysisType", SqlDbType.VarChar, 2);
                    myCMD.Parameters.Add("@BasedOnIndividual", SqlDbType.Int);
                    ...
                    myCMD.Parameters["@AnalysisType"].Value = "C";
                    myCMD.Parameters["@BasedOnIndividual"].Value = DBNull.Value;
        ...
        protected void Del_RDD_FilterSet_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CnnStr))
            {
                using (SqlCommand myCMD = new SqlCommand("Sp_Filter_VD_FilterSetAndItems_Del", con))
                {
                    myCMD.CommandType = CommandType.StoredProcedure;
                    con.Open();
                    myCMD.Parameters.Add("@UserID", SqlDbType.Int);
                    ...
                    myCMD.Parameters["@userID"].Value = Convert.ToInt32(Session["WiNGSMasterId"].ToString());
        ...
        protected void RDD_FilterSet_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@Control_num", SqlDbType.Int));
            ...
            try
            {
                ...
                if (RLB_Filter.Items.Count > 0)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "getReqIdSavedFilter", "get_reqId_savedFilter(" + Session["FilterID_Filter"] + ");", true);
            ...
            //SqlDataAdapter SqlDataAdptrCmd = new SqlDataAdapter();
            //// string selectCommand = "SELECT * FROM Tbl_GAP_Filter_Items where FilterID= " + Session["FilterID_Filter"] + " order by [Level]";
        ...
        {
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM Tbl_Filter_Category where CategoryState=1", CnnStr);
        ...
        private void CreateSqlDataSource(string DSId, string CntrlId, string whereCond)
        {
            ...
            div_Holder_hdns.Controls.Add(hdn);
        ...
        private void DisplayData(int selectedLevel)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "btnShow", "get_reqId(" + selectedLevel.ToString() + ");", true);
            ...
            //ResultPassFailList = GetResult(selectedLevel);
            //for (int i = 0; i < myDataTable.Rows.Count; i++)
            //{
            //    int rslt = (from a in ResultPassFailList where a.getLevel() == filterItemList[i].getLevel() select a.getResult()).FirstOrDefault();
            //    if (rslt != 0)
        ...
        private int GetReqId_GetResult(int selectedLevel)
        {
            ...
            SqlCommand cmdRslt = new SqlCommand("Sp_Filter_Result_Count_ReqId_Sel", conn);
        ...
        private List<FilterItems> GetResult(int selectedLevel)
        {
            ...
            SqlConnection conn = new SqlConnection(connstring);
            SqlDataAdapter SqlDataAdpt = new SqlDataAdapter();
            SqlCommand cmdRslt = new SqlCommand("Sp_Filter_Result_Count_Sel", conn);
            cmdRslt.CommandType = CommandType.StoredProcedure;
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                ...
                using (SqlCommand cmdSelect = new SqlCommand(selectCommand, conn))
                {
                    ...
                    if (myDataTable.Rows.Count > 0)
                    {
                        ...
                        //string rslt = (from a in filterItemResultList where a.getLevel() == 3 select a.getResult()).FirstOrDefault();
                        //    //if (rslt != 0)
                        //        filterItemList[0].setResult(rslt);

                        //string rslt4 = (from a in filterItemResultList where a.getLevel() == 4 select a.getResult()).FirstOrDefault();
                        ////if (rslt4 != 0)
                        //    filterItemList[1].setResult(rslt4);
                        ////}
        ...
        protected void ShowResultCondition_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Sp_GAP_VariantDiscovery_Public_Result_Variant_Sel", new SqlConnection(CnnStr));
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter SqlDataAdptrCmd = new SqlDataAdapter();
            SqlParameterCollection SqlParCol = default(SqlParameterCollection);
            SqlParCol = cmd.Parameters;

            cmd.Parameters.Add("@VarSearch", SqlDbType.NVarChar, -1);
            cmd.Parameters.Add("@FilterID", SqlDbType.Int);
            cmd.Parameters.Add("@Selected_FiterItemLevels_CommaSep", SqlDbType.NVarChar, 200);
            cmd.Parameters.Add("@SeqType", SqlDbType.NVarChar,50);
            cmd.Parameters.Add("@RefBuild", SqlDbType.NVarChar, 50);
            cmd.Parameters.Add("@UserID", SqlDbType.Int);

            cmd.Parameters["@VarSearch"].Value = Session["VariantDis_KeyForQuery"].ToString() + Session["VariantDis_ValueForQuery"].ToString();
            cmd.Parameters["@FilterID"].Value = Convert.ToInt32(Session["FilterID_Filter"].ToString());
            ...
            cmd.Parameters["@SeqType"].Value = Session["VariantDis_SeqType"].ToString();
            cmd.Parameters["@RefBuild"].Value = Session["VariantDis_RefBuild"].ToString();
            ...
            try
            {
                ...
                Response.Redirect(String.Format("/GAP/VariantDiscovery_Result.aspx"), false);
            }
            catch (SqlException se)
            {
                string msg = se.Message;
        ...
        public void GetCountForSelectedSavedFilter()
        {
            ...
            using (SqlConnection conn = new SqlConnection(CnnStr))
            {
                ...
                cmdSelect.Parameters.Add(new SqlParameter("@Control_num", SqlDbType.Int));
