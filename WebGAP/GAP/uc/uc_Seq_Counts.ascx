<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Seq_Counts.ascx.cs" Inherits="WebGAP.GAP.uc.uc_Seq_Counts" %>
...
<script type="text/javascript">
    ...
    jQuery.ajax({
        ...
        async: true,
        dataType: 'JSON',
        url: 'Service/se_Sample_Quality.asmx/getResults_Quality_Samples1',
