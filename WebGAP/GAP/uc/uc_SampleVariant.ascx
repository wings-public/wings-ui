<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_SampleVariant.ascx.cs" Inherits="WebGAP.GAP.uc.uc_SampleVariant" %>
...
<div class="content-header row">
    <div class="content-header-left" style="width: 98%">
        <h3 class="content-header-title">
            <asp:PlaceHolder runat="server"><%: String.Concat("Sample ",Session["SampleID_Filter"]) %> </asp:PlaceHolder>
        </h3>
        <br />
...
<div class="content-body">
    ...
    <section id="basic-form-layouts">
                                            ...
                                            <telerik:RadPageView ID="RadPageView1" runat="server">
                                                ...
                                                <table class="tbl-container">
                                                    ...
                                                    <tr class="h-30">
                                                        ...
                                                        <td>
                                                            <b>Zygosity : </b>
                                                            <asp:Label runat="server" ID="lbl_geno" Text='<%# Bind("GENO") %>' />
                                                        </td>
                                                        <td>
                                                            <b>Gene : </b>
                                                            <asp:Label runat="server" ID="lbl_gene" Text='<%# Bind("GENE") %>' />
                                                        </td>
                                                        <td><b>Exon/Intron number : </b>
                                                    ...
                                                    <tr class="h-30">
                                                        <td colspan="3">
                                                            <table style="width: 100%" class="tbl_cov">
                                                                <tr>
                                                                    <td style="width: 50%; padding-left: 7px">
                                                                        <b>Coverage (Alternate/Reference) : </b>
                                                                        <asp:Label runat="server" ID="lbl_cov" Text='<%# String.Concat(Eval("COV")," (",Eval("AO"),"/",Eval("RO"),")") %>' />
                                                                    </td>
                                                                    <td style="width: 50%">
                                                                        <asp:HiddenField runat="server" ID="hdn_af" Value='<%# Bind("AF") %>' />
                                                                        <b>Variant Allele Frequency :</b>
                                                                        <asp:Label runat="server" ID="Label1" Text='<%# Bind("AF") %>' CssClass="padding-left" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr class="h-30">
                                                        <td>
                                                            <b>Quality : </b>
                                                            <asp:Label runat="server" ID="lbl_qual" Text='<%# Bind("QUAL") %>' />
                                                        </td>
                                                        <td>
                                                            <b>Genotype Quality : </b>
                                                            <asp:Label runat="server" ID="lbl_genoqual" Text='<%# Bind("GENO_QUAL") %>' />
                                                        </td>
                                                        <td>
                                                            <b>Filter : </b>
                                                ...
                                                <table class="tbl-container" runat="server">
                                                    <tr>
                                                        <td colspan="3">
                                                            ...
                                                            <%--<telerik:RadComboBox ID="RLV_Lab_Findings" runat="server" DataTextField="SampleID"
                                                                DataSourceID="Ds_SampleVariant_Lab_Finding" AutoPostBack="true" >

                                                            </telerik:RadComboBox>--%>

                                                            <h5>There are some . . . </h5>
                                                            <telerik:RadListBox runat="server" ID="RLV_Lab_Findings" RenderMode="Lightweight" CssClass="RLB_LabF"
                                                                DataSourceID="Ds_SampleVariant_Lab_Finding" DataTextField="SampleID" DataKeyField="SampleID">
                                            ...
                                            <telerik:RadPageView ID="RadPageView6" runat="server">
                                                ...
                                                <telerik:RadTabStrip RenderMode="Lightweight" runat="server" ID="RTS_Population" CssClass="RTS_Population" MultiPageID="RadMultiPage_Population" SelectedIndex="0" Skin="Silk">
                                                    <Tabs>
                                                        ...
                                                        <telerik:RadTab Text="Iranom" Width="90px"></telerik:RadTab>
                                                        <telerik:RadTab Text="GenAP" Width="80px"></telerik:RadTab>
                                                    </Tabs>
                                                </telerik:RadTabStrip>
                                                                    ...
                                                                    <table class="tbl-container" runat="server">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label2" Text='<%# Bind("gnomAD_Hom_AFR") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label3" Text='<%# Bind("gnomAD_AF_AFR") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label4" Text='<%# Bind("gnomAD_Hom_ASJ") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label5" Text='<%# Bind("gnomAD_AF_ASJ") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <h7>East Asian</h7>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label6" Text='<%# Bind("gnomAD_Hom_EAS") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label7" Text='<%# Bind("gnomAD_AF_EAS") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label8" Text='<%# Bind("gnomAD_Hom_FIN") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label9" Text='<%# Bind("gnomAD_AF_FIN") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label10" Text='<%# Bind("gnomAD_Hom_NFE") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label11" Text='<%# Bind("gnomAD_AF_NFE") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <h7>Latino</h7>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label12" Text='<%# Bind("gnomAD_Hom_AMR") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label13" Text='<%# Bind("gnomAD_AF_AMR") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <h7>South Asian</h7>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label14" Text='<%# Bind("gnomAD_Hom_SAS") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label15" Text='<%# Bind("gnomAD_AF_SAS") %>' /></td>
                                                                            </tr>
                                                                            <tr style="border-bottom: none">
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label16" Text='<%# Bind("gnomAD_Hom_OTH") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label17" Text='<%# Bind("gnomAD_AF_OTH") %>' /></td>
                                                                            </tr>
                                                                            <tr style="border-top: 1px solid #14AFCA; border-bottom: 1px solid #14AFCA">
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label18" Text='<%# Bind("gnomAD_Hom_ALL") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label19" Text='<%# Bind("gnomAD_AF_ALL") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <h7>Female</h7>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label20" Text='<%# Bind("gnomAD_Hom_Female") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label21" Text='<%# Bind("gnomAD_AF_Female") %>' /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <h7>Male</h7>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label22" Text='<%# Bind("gnomAD_Hom_Male") %>' /></td>
                                                                                <td>
                                                                                    <asp:Label runat="server" ID="Label23" Text='<%# Bind("gnomAD_AF_Male") %>' /></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <table class="tbl-container" runat="server">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label24" Text='<%# Bind("PaPI_score") %>' /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <h7>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label29" Text='<%# Bind("PolyPhen_2_score") %>' /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <h7>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label37" Text='<%# Bind("SIFT_score") %>' /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <h7>
                                                                        ...
                                                                        <td>-</td>
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label31" Text='<%# Bind("dbscSNV_AB_score") %>' /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <h7>
                                                                        ...
                                                                        <td>-</td>
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label33" Text='<%# Bind("dbscSNV_RF_score") %>' /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <h7>
                                                                        ...
                                                                        <td>-</td>
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label34" Text='<%# Bind("DANN_score") %>' /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <h7>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label runat="server" ID="Label35" Text='<%# Bind("PseeAC_RF_score") %>' /></td>
                                                                    </tr>
        ...
        <asp:SqlDataSource ID="Ds_SampleVariant" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
            SelectCommand="Sp_GAP_Result_SqlQuery" SelectCommandType="StoredProcedure">
            <SelectParameters>
                ...
                <asp:SessionParameter Name="IndividualID" SessionField="IndividualID_Filter" Type="String" />
        ...
        <asp:SqlDataSource ID="Ds_SampleVariant_Lab_Finding" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
            SelectCommand="Sp_Sample_Variant_LabFinding" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>" ID="Ds_SampleVariant_Lab_Knowledge"
            ...
            <InsertParameters>
                ...
                <%--<asp:ControlParameter ControlID="DDL_St" Name="State" PropertyName="SelectedValue" Type="String" />--%>
