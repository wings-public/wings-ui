...
{
    public partial class uc_SampleVariant_Filter : System.Web.UI.UserControl
    {
      ...
      "PS2" ,"PS3" ,"PS4" ,"PM1" ,"PM2" ,"PM3" ,"PM4" ,"PM5" ,"PM6" ,"PP1" ,"PP2" ,"PP3" ,"PP4" ,"PP5" ,"BA1" ,"BS1" ,"BS2" ,"BS3" ,"BS4" ,"BP1" ,"BP2" ,"BP3" ,"BP4" ,"BP5" ,"BP6" ,"BP7" ,"BP8" });
        ...
        private List<RadTextBox> textBoxes_ = null;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    string fn = file.Name.Replace(".png", "");
                    RadComboBoxItem item = new RadComboBoxItem(fn.Substring(0, 1).ToUpper() + fn.Substring(1));
            ...
            lbl_sampleID.Text = "Sample ID " + Session["SampleID_Filter"];

            RLB_SelectedPanelList.Visible = false;
        ...
        private void Fetch_Count_Of_Data(string session, Label lbl)
        {
            if (!getFirstChild() && (Session["FilterID_Filter"].ToString() != ""))
            {
                ...
                SqlCommand cmd = new SqlCommand("Sp_GAP_Add_First_Item_To_FilterItems", conn);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add("@SampleID", SqlDbType.VarChar, 20);
                cmd.Parameters.Add("@FilterID", SqlDbType.Int);
                cmd.Parameters.Add("@UserID", SqlDbType.Int);
                cmd.Parameters.Add("@CenterID", SqlDbType.BigInt);
                cmd.Parameters.Add("@Counte", SqlDbType.Int);

                cmd.Parameters["@SampleID"].Value = Session["SampleID_Filter"].ToString();
                ...
                cmd.Parameters["@CenterID"].Value = Convert.ToInt64(Session["Current_CenterID"].ToString());
        ...
        protected void RBAdd_Click(object sender, EventArgs e)
        {
            ...
            if (RLB_Filter.Items.Count.Equals(0))
            {
                ...
                RBAddSelectedItem.Text = "Save your selected list";
                RBAddSelectedItem.Style.Remove("background-color");
                RBAddSelectedItem.Style.Remove("color");
            }
            ...
            switch (btn_value)
            {
                ...
                case "clinvar":
                    ...
                    if (!string.IsNullOrEmpty(RCB_Clinvar.SelectedValue))
                    {
                        ...
                        RLB_Filter.Items.Add(new RadListBoxItem
                        {
                            Value = "ClinVar_clinical_significance LIKE '%" + RCB_Clinvar.SelectedValue + "%'  COLLATE SQL_Latin1_General_Cp1_CS_AS",
                ...
                case "ChrPos":
                    if (string.IsNullOrEmpty(chr.Text))
                    {
                        chr.Focus();
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrEmpty(chr.Text) && (!string.IsNullOrEmpty(end.Text) || !string.IsNullOrEmpty(start.Text)))
                            values += "CHR = '" + chr.Text + "' and ";
                        else if (!string.IsNullOrEmpty(chr.Text) && string.IsNullOrEmpty(end.Text) && string.IsNullOrEmpty(start.Text))
                            values += "CHR = '" + chr.Text + "'";

                        if ((!string.IsNullOrEmpty(start.Text)) && (string.IsNullOrEmpty(end.Text)))
                            values += " [START] <= " + start.Text + " and [END] >= " + start.Text;
                        else if ((!string.IsNullOrEmpty(end.Text)) && (!string.IsNullOrEmpty(start.Text)))
                            values += " [START] <= " + start.Text + " and [END] >= " + end.Text;
                        else if ((!string.IsNullOrEmpty(end.Text)) && (string.IsNullOrEmpty(start.Text)))
                            values += " [START] <= " + end.Text + " and [END] >= " + end.Text;
        ...
        private void DisplayData()
        {
            ...
            finally
            {
                ...
                {
                    firstLi.Style.Add("margin-left", "11px");
                }
        ...
        private List<FilterItem> GetResult(SqlConnection conn)
        {
            ...
            try
            {
                ...
                SqlDataAdapter SqlDataAdpt = new SqlDataAdapter();
                SqlCommand cmdRslt = new SqlCommand("Sp_GAP_Result_FilterItems", conn);
                ...
                cmdRslt.Parameters.Add(new SqlParameter("@IndividualID", Session["IndividualID_Filter"].ToString()));
        ...
        private List<FilterItem> GetMaterializedPath(SqlConnection conn)
        {
            ...
            {
                SqlDataAdapter SqlDataAdpt = new SqlDataAdapter();
                SqlCommand cmdRslt = new SqlCommand("Sp_GAP_Result_Del_FilterItems", conn);
        ...
        protected void RBAddPanelList_Click(object sender, EventArgs e)
        {
            ...
            {
                RLB_SelectedPanelList.Visible = Visible;
        ...
        protected void ShowResultCondition_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(String.Format("/GAP/SampleVariant.aspx"));
        }
        ...
        protected void RDD_FilterSet_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string selectedItemCommand = "SELECT * FROM Tbl_GAP_Filter_SelectedItems where FilterID= " + Session["FilterID_Filter"];
        ...
        protected void Del_RDD_FilterSet_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CnnStr))
            {
                using (SqlCommand myCMD = new SqlCommand("Sp_GAP_Filter_Del_FilterSet", con))
                {
                    myCMD.CommandType = CommandType.StoredProcedure;
                    con.Open();
                    myCMD.Parameters.Add("@UserID", SqlDbType.Int);
        ...
        protected void RBAddSelectedItem_Click(object sender, EventArgs e)
        {
            if (RLB_Filter.Items.Count > 0)
            {
                ...
                SqlCommand cmdUIS = new SqlCommand("Sp_GAP_Filter_SelectedItems_Sel", conn);
                cmdUIS.CommandType = CommandType.StoredProcedure;
                ...
                RBAddSelectedItem.Text = "Saved!";
                RBAddSelectedItem.Style.Add("background-color", "#2BB013");
                RBAddSelectedItem.Style.Add("color", "#ffffff");
        ...
        {
            uc_SampleVariant_Filter mainClass = new uc_SampleVariant_Filter();
            ...
            public void ThreadProc()
            {
                ...
                using (SqlConnection Conn = new SqlConnection(CnnStr))
                {
                    ...
                    {
                        s.DestinationTableName = "Tbl_GAP_Filter_SelectedItems";
        ...
        protected void RLB_SelectedPanelList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RLB_SelectedPanelList.Visible = true;
        ...
        protected void RLB_SavedFilterItem_Deleting(object sender, RadListBoxDeletingEventArgs e)
        {
            if (!String.IsNullOrEmpty(RLB_SavedFilterItem.SelectedValue.ToString()))
            {
                ...
                SqlCommand cmdUIS = new SqlCommand("Sp_GAP_Filter_SelectedItems_Saved_Del", conn);
                cmdUIS.CommandType = CommandType.StoredProcedure;
