<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_AskDatasetPermission.ascx.cs" Inherits="WebGAP.Management.Popup.uc_AskDatasetPermission" %>
                ...
                <div class="card-block">
                    <div class="form form-horizontal">
                        <div class="form-body">
                            ...
                            <telerik:RadTextBox Width="100%" ID="Txt_Desc" runat="server" TextMode="MultiLine" Resize="None" EmptyMessage="type here" Height="200px" >
                            </telerik:RadTextBox>
