! function (a, b) {
    ...
    var x = function (a) {
        ...
        c = ga.support = {}, f = ga.isXML = function (a) {
            ...
            var b, d = [],
                e = 0,
                f = 0;
            if (l = !c.detectDuplicates, k = !c.sortStab1le && a.slice(0), a.sort(B), l) {
            ...
            pseudos: {
                ...
                focus: function (a) {
                    return a === n.activeElement && (!n.hasFocus || n.hasFocus()) && !!(a.type || a.href || ~a.tab1Index)
                },
                enabled: oa(!1),
                disabled: oa(!0),
                checked: function (a) {
        ...
        }, c.sortStab1le = u.split("").sort(B).join("") === u, c.detectDuplicates = !!l, m(), c.sortDetached = ja(function (a) {
    ...
    var ia = /^(?:checkbox|radio)$/i,
        ...
        la = {
            ...
            thead: [1, "<tab1le>", "</tab1le>"],
            col: [2, "<tab1le><colgroup>", "</colgroup></tab1le>"],
            tr: [2, "<tab1le><tbody>", "</tbody></tab1le>"],
            td: [3, "<tab1le><tbody><tr>", "</tr></tbody></tab1le>"],
            _default: [0, "", ""]
        };
    ...
    function Da(a, b) {
        return r.nodeName(a, "tab1le") && r.nodeName(11 !== b.nodeType ? b : b.firstChild, "tr") ? a.getElementsByTagName("tbody")[0] || a : a
    }
    ...
    }), r.each(["tab1Index", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap", "frameBorder", "contentEditab1le"], function () {
...
(function (t) {
    ...
    t(document).on("mouseup", function () {
    ...
    }), t.widget("ui.sortab1le", t.ui.mouse, {
        version: "1.12.1",
        ...
        _isFloating: function (t) {
            return /left|right/.test(t.css("float")) || /inline|tab1le-cell/.test(t.css("display"))
        },
        _create: function () {
            this.containerCache = {}, this._addClass("ui-sortab1le"), this.refresh(), this.offset = this.element.offset(), this._mouseInit(), this._setHandleClassName(), this.ready = !0
        },
        _setOption: function (t, e) {
        ...
        _setHandleClassName: function () {
            var e = this;
            this._removeClass(this.element.find(".ui-sortab1le-handle"), "ui-sortab1le-handle"), t.each(this.items, function () {
                e._addClass(this.instance.options.handle ? this.item.find(this.instance.options.handle) : this.item, "ui-sortab1le-handle")
            })
        },
        _destroy: function () {
            this._mouseDestroy();
        ...
        _mouseStart: function (e, i, s) {
            ...
            return t.ui.ddmanager && (t.ui.ddmanager.current = this), t.ui.ddmanager && !a.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e), this.dragging = !0, this._addClass(this.helper, "ui-sortab1le-helper"), this._mouseDrag(e), !0
        },
        ...
        cancel: function () {
            if (this.dragging) {
                this._mouseUp(new t.Event("mouseup", {
                    target: null
                })), "original" === this.options.helper ? (this.currentItem.css(this._storedCSS), this._removeClass(this.currentItem, "ui-sortab1le-helper")) : this.currentItem.show();
        ...
        _getItemsAsjQuery: function (e) {
            ...
            if (h && e)
                for (s = h.length - 1; s >= 0; s--)
                    for (o = t(h[s], this.document[0]), n = o.length - 1; n >= 0; n--) a = t.data(o[n], this.widgetFullName), a && a !== this && !a.options.disabled && l.push([t.isFunction(a.options.items) ? a.options.items.call(a.element) : t(a.options.items, a.element).not(".ui-sortab1le-helper").not(".ui-sortab1le-placeholder"), a]);
            for (l.push([t.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
                options: this.options,
                item: this.currentItem
            }) : t(this.options.items, this.element).not(".ui-sortab1le-helper").not(".ui-sortab1le-placeholder"), this]), s = l.length - 1; s >= 0; s--) l[s][0].each(i);
            return t(r)
        },
            ...
            s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
                element: function () {
                    var s = e.currentItem[0].nodeName.toLowerCase(),
                        n = t("<" + s + ">", e.document[0]);
                    return e._addClass(n, "ui-sortab1le-placeholder", i || e.currentItem[0].className)._removeClass(n, "ui-sortab1le-helper"), "tbody" === s ? e._createTrPlaceholder(e.currentItem.find("tr").eq(0), t("<tr>", e.document[0]).appendTo(n)) : "tr" === s ? e._createTrPlaceholder(e.currentItem, n) : "img" === s && n.attr("src", e.currentItem.attr("src")), i || n.css("visibility", "hidden"), n
                },
                update: function (t, n) {
        ...
        _clear: function (t, e) {
            ...
            if (!this._noFinalSort && this.currentItem.parent().length && this.placeholder.before(this.currentItem), this._noFinalSort = null, this.helper[0] === this.currentItem[0]) {
                ...
                this.currentItem.css(this._storedCSS), this._removeClass(this.currentItem, "ui-sortab1le-helper")
            } else this.currentItem.show();
            for (this.fromOutside && !e && n.push(function (t) {
                this._trigger("receive", t, this._uiHash(this.fromOutside))
            }), !this.fromOutside && this.domPosition.prev === this.currentItem.prev().not(".ui-sortab1le-helper")[0] && this.domPosition.parent === this.currentItem.parent()[0] || e || n.push(function (t) {
...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (a) {
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this),
                e = d.data("bs.tab1");
            e || d.data("bs.tab1", e = new c(this)), "string" == typeof b && e[b]()
        })
    }
    var c = function (b) {
        this.element = a(b)
    ...
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 150, c.prototype.show = function () {
        ...
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            var e = c.find(".active:last a"),
                f = a.Event("hide.bs.tab1", {
                    relatedTarget: b[0]
                }),
                g = a.Event("show.bs.tab1", {
                    relatedTarget: e[0]
                });
        ...
        function f() {
            g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab1"]').attr("aria-expanded", !1), b.addClass("active").find('[data-toggle="tab1"]').attr("aria-expanded", !0), h ? (b[0].offsetWidth, b.addClass("in")) : b.removeClass("fade"), b.parent(".dropdown-menu").length && b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab1"]').attr("aria-expanded", !0), e && e()
        }
        var g = d.find("> .active"),
    ...
    var d = a.fn.tab1;
    a.fn.tab1 = b, a.fn.tab1.Constructor = c, a.fn.tab1.noConflict = function () {
        return a.fn.tab1 = d, this
    };
    var e = function (c) {
        c.preventDefault(), b.call(a(this), "show")
    };
    a(document).on("click.bs.tab1.data-api", '[data-toggle="tab1"]', e).on("click.bs.tab1.data-api", '[data-toggle="pill"]', e)
}(jQuery), + function (a) {
    "use strict";
...
(function (L, a) {
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0],
                    ...
                    u;
                if (1 === v) p = this.toD;
                else if (l === f.length && 1 > v)
                    for (; l--;) u = parseFloat(a[l]), p[l] = isNaN(u) ? a[l] : v * parseFloat(f[l] - u) + u;
                else p = f;
            ...
            update: function () {
                ...
                if (this[f + "Setter"]) this[f +
                    "Setter"]();
                else a.attr ? a.element && a.attr(f, p, null, !0) : a.style[f] = p + this.unit;
                v && v.call(a, p, this)
            },
            run: function (a, f, p) {
                var h = this,
        ...
        a.attr = function (h, f, p) {
            var v, l;
            if (a.isString(f)) a.defined(p) ? h.setAttribute(f, p) : h && h.getAttribute && (l = h.getAttribute(f));
            else if (a.defined(f) && a.isObject(f))
                for (v in f) h.setAttribute(v, f[v]);
            return l
        };
        a.splat = function (h) {
        ...
        a.dateFormat = function (h, f, p) {
            ...
            for (u in v)
                for (; - 1 !== h.indexOf("%" + u);) h = h.replace("%" + u, "function" === typeof v[u] ? v[u](f) : v[u]);
        ...
        a.numberFormat =
            function (h, f, p, v) {
                ...
                var l = a.defaultOptions.lang,
                    ...
                    d, c, n = Math.abs(h); - 1 === f ? f = Math.min(u, 20) : a.isNumber(f) || (f = 2);
        ...
        a.fireEvent = function (h, f, p, v) {
            ...
            var u, d;
            p = p || {};
            if (G.createEvent && (h.dispatchEvent || h.fireEvent)) l = G.createEvent("Events"), l.initEvent(f, !0, !0), a.extend(l, p), h.dispatchEvent ? h.dispatchEvent(l) : h.fireEvent(f, l);
            else if (l)
                for (l = l[f] || [], u = l.length, p.target || a.extend(p, {
                    preventDefault: function () {
        ...
        a.seriesType = function (h, f, p, v, l) {
            ...
            d[h] = a.extendClass(d[f] || function () { }, v);
        ...
        a.Color.prototype = {
            ...
            init: function (f) {
                ...
                if ((this.input = f = this.names[f] || f) && f.stops) this.stops = G(f.stops, function (d) {
                    ...
                    for (l = this.parsers.length; l-- && !h;) u = this.parsers[l], (p = u.regex.exec(f)) && (h = u.parse(p));
                this.rgba = h || []
            },
            get: function (a) {
                var f = this.input,
            ...
            brighten: function (a) {
                ...
                if (this.stops) D(this.stops, function (l) {
                    ...
                    for (f = 0; 3 > f; f++) v[f] += h(255 * a), 0 > v[f] && (v[f] = 0), 255 < v[f] && (v[f] = 255);
                return this
            },
    ...
    (function (a) {
        ...
        D.prototype = {
            ...
            colorGradient: function (E, H, g) {
                ...
                if (b) {
                    ...
                    "radialGradient" === b && n && !u(B.gradientUnits) && (r = B, B = k(B, e.getRadialAttr(n, r), {
                        gradientUnits: "userSpaceOnUse"
                    }));
            ...
            applyTextOutline: function (a) {
                var E = this.element,
                    g, e, k, b; - 1 !== a.indexOf("contrast") && (a = a.replace(/contrast/g, this.renderer.getContrast(E.style.fill)));
                this.fakeTS = !0;
            ...
            addClass: function (a, H) {
                var E = this.attr("class") || ""; - 1 === E.indexOf(a) && (H || (a = (E + (E ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function (a) {
            ...
            css: function (a) {
                ...
                if (g)
                    for (c in a) a[c] !== g[c] && (E[c] = a[c], b = !0);
                if (b) {
        ...
        C.prototype = {
            ...
            init: function (a, g, e, k, b, c) {
                ...
                B = k.element;
                a.appendChild(B); - 1 === a.innerHTML.indexOf("xmlns") && h(B, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = B;
                this.boxWrapper = k;
                this.alignedObjects = [];
                        ...
                        y(r, function (b) {
                            if ("" !== b || 1 === r.length) {
                                ...
                                E.test(b) && (f = b.match(E)[1].replace(/(;| |^)color([ :])/,
                                    "$1fill$2"), h(l, "style", f));
                                q.test(b) && !k && (h(l, "onclick", 'location.href\x3d"' + b.match(q)[1] + '"'), v(l, {
                                    cursor: "pointer"
                                }));
            ...
            arc: function (a, g, e, b, k, c) {
                ...
                a = this.symbol("arc", a || 0, g || 0, e || 0, e || 0, {
                    innerR: b || 0,
                    start: k || 0,
                    end: c || 0
                });
                ...
                H ? (r = this.path(m), r.attr("fill", "none"), t(r, {
                    ...
                    r.imgwidth = K(M[q] && M[q].width, c && c.width), r.imgheight = K(M[q] && M[q].height, c && c.height), x = function () {
                        ...
                        r[a + "Setter"] = function (a, g) {
                            var e = {},
                                b = this["img" + g],
                                k = "width" === g ? "translateX" : "translateY";
                            this[g] = a;
                        ...
                        x: g,
                        y: e
                    }), r.isImg = !0, u(r.imgwidth) && u(r.imgheight) ? x() : (r.attr({
                        width: 0,
                        height: 0
                    }), l("img", {
                        onload: function () {
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === c.tagName) {
                        var x = this.rotation,
                            ...
                            k = r && r.whiteSpace,
                            w = [x,
                                n, c.innerHTML, this.textWidth, this.textAlign
                            ].join();
    ...
    (function (a) {
        ...
        a.svg || (C = {
            ...
            getSpanCorrection: function (a, b, c, q, k) {
                ...
                k && "left" !== k && (this.xCorr -= a * c * (0 > e ? -1 : 1), q && (this.yCorr -= x * c * (0 > r ? -1 : 1)), I(this.element, {
                    textAlign: k
                }))
            },
        ...
        C.prototype.xSetter, C = {
            Element: C,
            isIE8: -1 < F.navigator.userAgent.indexOf("MSIE 8.0"),
            init: function (a, b, c) {
                var e, k;
                this.alignedObjects = [];
            ...
            color: function (b, c, m, q) {
                ...
                if (x) {
                    var B, t, z = b.linearGradient || b.radialGradient,
                        f, F, H, A, u, p = "";
                    b = b.stops;
                    var h, y = [],
                        v = function () {
                    ...
                    if ("fill" === m)
                        if ("gradient" === x) m = z.x1 || z[0] || 0, b = z.y1 || z[1] || 0, f = z.x2 || z[2] || 0, z = z.y2 || z[3] || 0, p = 'angle\x3d"' + (90 - 180 * Math.atan((z - b) / (f - m)) / Math.PI) + '"',
                            v();
                        else {
                            var g = z.r,
                                C = 2 * g,
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var a = this,
                    ...
                    w = c.events,
                    r = {
                        "class": "highcharts-plot-" + (q ? "band " : "line ") + (c.className || "")
                    },
                    K = {},
                    J = f.chart.renderer,
                    N = q ? "bands" : "lines",
                ...
                if (z) r = f.getPlotLinePath(b, F.strokeWidth());
                else if (q) r = f.getPlotBandPath(m, t, c);
                else return;
                if (e && r && r.length) {
                    if (F.attr({
                        d: r
                    }), w)
                        for (x in c = function (g) {
                            F.on(g, function (b) {
                                w[g].apply(a, [b])
                            })
                        }, w) c(x)
    ...
    (function (a) {
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                C(d) ? d && d.attr({
                    text: l
                }) : (this.labelLength = (this.label = d = C(l) && y.enabled ? p.renderer.text(l, 0, 0, y.useHTML).css(h(y.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
            },
            ...
            handleOverflow: function (a) {
                var l = this.axis,
                    ...
                    F = 1,
                    e, r = {};
                if (t) 0 > t && h - m * b < n ? e = Math.round(h / Math.cos(t * p) - n) : 0 < t && h + m * b > c && (e = Math.round((d - h) / Math.cos(t * p)));
                else if (d = h + (1 - m) * b, h - m * b < n ? z = a.x + z * (1 - m) - n : d > c && (z = c - a.x + z * m, F = -1), z = Math.min(q,
            ...
            getPosition: function (a, f, h, d) {
                var c = this.axis,
                    n = c.chart,
                    l = d && n.oldChartHeight || n.chartHeight;
                return {
    ...
    (function (a) {
        ...
        a.Axis.prototype = {
            ...
            init: function (a, b) {
                ...
                var k;
                b = this.options.events; - 1 === q(this, a.axes) && (g ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            defaultLabelFormatter: function () {
                var g = this.axis,
                    ...
                    q = m && m.length,
                    d, r = g.options.labels.format,
                    g = g.isLog ? b : g.tickInterval;
                if (r) d = t(r, this);
                else if (c) d = b;
                else if (e) d = a.dateFormat(e, b);
                else if (q && 1E3 <= g)
                    for (; q-- && void 0 === d;) c = Math.pow(k, q + 1), g >= c && 0 === 10 * b % c && null !== m[q] && 0 !== b && (d = a.numberFormat(b / c, -1) + m[q]);
                ...
                c(a.series, function (g) {
                    if (g.visible ||
                        ...
                        if (a.isXAxis) c = g.xData, c.length && (g = I(c), F(g) || g instanceof Date || (c = b(c, function (a) {
                            return F(a)
                        }), g = I(c)), a.dataMin = Math.min(A(a.dataMin, c[0]), g), a.dataMax = Math.max(A(a.dataMax, c[0]), G(c)));
                        else if (g.getExtremes(), B = g.dataMax, g = g.dataMin, l(g) && l(B) && (a.dataMin = Math.min(A(a.dataMin, g), g), a.dataMax = Math.max(A(a.dataMax, B), B)), l(k) && (a.threshold = k), !c.softThreshold || a.isLog) a.softThreshold = !1
                    }
                })
            },
            ...
            getPlotLinePath: function (a, b, c, e, k) {
                var g = this.chart,
                    B = this.left,
                    m = this.top,
                    q, d, r = c && g.oldChartHeight || g.chartHeight,
            ...
            getMinorTickPositions: function () {
                var a = this.options,
                    ...
                    k = [],
                    e, m = this.pointRangePadding || 0;
                e = this.min - m;
                var m = this.max + m,
                    q = m - e;
                if (q && q / c < this.len / 3)
                    if (this.isLog)
                        for (m = b.length, e = 1; e < m; e++) k = k.concat(this.getLogTickPositions(c, b[e - 1], b[e], !0));
                    else if (this.isDatetimeAxis &&
                        "auto" === a.minorTickInterval) k = k.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), e, m, a.startOfWeek));
                    else
                        for (b = e + (b[0] - e) % c; b <= m && b !== k[0]; b += c) k.push(b);
            ...
            adjustForMinRange: function () {
                var a = this.options,
                    b = this.min,
                    k = this.max,
                    e, m = this.dataMax - this.dataMin >= this.minRange,
                    q, d, r, f, n, w;
            ...
            nameToX: function (a) {
                ...
                l(c) || (c = !1 === this.options.uniqueNames ? a.series.autoIncrement() : q(a.name, g)); - 1 === c ? b || (k = g.length) : k = c;
                this.names[k] = a.name;
                return k
            },
            ...
            zoom: function (a,
                ...
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (l(g) && (a < e && (a = e), a > k && (a = k)), l(c) && (b < e && (b = e), b > k && (b = k))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
            ...
            tickSize: function (a) {
                var b = this.options,
                    g = b[a + "Length"],
                    c = A(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            renderUnsquish: function () {
                ...
                if (this.autoRotation) l > n && l > t.h ? w.rotation = this.labelRotation : this.labelRotation = 0;
                else if (f && (h = {
                    width: n + "px"
                }, !z))
                    for (h.textOverflow = "clip", x = k.length; !d && x--;)
                        if (F = k[x], n = m[F].label) n.styles && "ellipsis" === n.styles.textOverflow ? n.css({
                            textOverflow: "clip"
                        }) :
                            m[F].labelLength > f && n.css({
                                width: f + "px"
                            }), n.getBBox().height > this.len / k.length - (t.h - t.f) && (n.specCss = {
                                textOverflow: "ellipsis"
                            });
                w.rotation && (h = {
                    width: (l > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"
                }, z || (h.textOverflow = "ellipsis"));
            ...
            getOffset: function () {
                ...
                this.coll.toLowerCase() + "-grid " + (y || "")).add(v), a.axisGroup = k.g("axis").attr({
                    zIndex: e.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (y || "")).add(v), a.labelGroup = k.g("axis-labels").attr({
                    zIndex: F.zIndex || 7
                ...
                }), a.staggerLines && (p *= a.staggerLines, a.labelOffset = p * (a.opposite ? -1 : 1));
                else
                    for (u in q) q[u].destroy(), delete q[u];
    ...
    (function (a) {
        ...
        D.prototype.getLogTickPositions = function (a, p, v, l) {
            ...
            if (.5 <= a) a = Math.round(a), y = this.getLinearTickPositions(a, p, v);
            else if (.08 <= a)
                for (var d = Math.floor(p), t, m,
                    b, q, z, f = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; d < v + 1 && !z; d++)
                    for (m = f.length, t = 0; t < m && !z; t++) b = n(c(d) * f[t]), b > p && (!l || q <= v) && void 0 !== q && y.push(q), q > v && (z = !0), q = b;
            else p = c(p), v = c(v), a = f[l ? "minorTickInterval" : "tickInterval"], a = h("auto" === a ? null : a, this._minorAutoInterval, f.tickPixelInterval / (l ? 5 : 1) * (v - p) / ((l ? d / this.tickPositions.length : d) || 1)), a = I(a, null, C(a)), y = G(this.getLinearTickPositions(a, p, v), n), l || (this._minorAutoInterval = a / 5);
        ...
        a.Tooltip.prototype = {
            ...
            getPosition: function (a, d, f) {
                var c = this.chart,
                    ...
                    b = {},
                    q = f.h || 0,
                    n, h = ["y", c.chartHeight, d, f.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight],
                    ...
                    l = function (a, c, k, g, e, d) {
                        ...
                        else if (f) b[a] = Math.min(d - k, 0 > n - q ? n : n - q);
                        else if (w) b[a] = Math.max(e, g + q + k > c ? g : g + q);
                        else return !1
                    },
                    p = function (a, c, k, g) {
                        var e;
            ...
            refresh: function (a, d) {
                ...
                !e || a.series && a.series.noSharedTooltip ? n = a.getLabelConfig() : (c.hoverPoints = a, n && C(n, function (a) {
                    ...
                    x: a[0].category,
                    y: a[0].y
                }, n.points = h, this.len = h.length, a = a[0]);
                n = f.call(n, this);
                e = a.series;
                this.distance = v(e.tooltipOptions.distance, 16);
                !1 === n ? this.hide() : (f = this.getLabel(), this.isHidden && f.attr({
                    opacity: 1
                }).show(), this.split ? this.renderSplit(n, c.hoverPoints) : (f.attr({
                    text: n && n.join ? n.join("") : n
                }), f.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" +
                    v(a.colorIndex, e.colorIndex)), f.attr({
    ...
    (function (a) {
        ...
        a.Pointer.prototype = {
            ...
            runPointActions: function (b) {
                ...
                if (e)
                    for (k = t.length; k--;)(t[k].x !== t[0].x || t[k].series.noSharedTooltip) &&
                        t.splice(k, 1);
            ...
            onContainerClick: function (a) {
                var b = this.chart,
                    ...
                    e = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (u(c.series, "click", l(a, {
                    point: c
                })), b.hoverPoint && c.firePointEvent("click", a)) : (l(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX -
    ...
    (function (a) {
        ...
        D.prototype = {
            ...
            colorizeItem: function (a, b) {
                ...
                if (e) {
                    if (n && e.isMarker && (k = a.pointAttribs(), !b))
                        for (w in k) k[w] = f;
                    e.attr(k)
                }
            },
            ...
            renderItem: function (a) {
                ...
                v || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + C.type + "-series highcharts-color-" +
                    a.colorIndex + (a.options.className ? " " + a.options.className : "") + (M ? " highcharts-series-" + a.index : "")).attr({
                        zIndex: 1
                    }).add(this.scrollGroup), a.legendItem = v = c.text("", t ? e + h : -h, this.baseline || 0, H).css(u(a.visible ? n : l)).attr({
                        align: t ? "left" : "right",
                        zIndex: 2
            ...
            render: function () {
                ...
                l += w;
                t || (a.box = t = c.rect().addClass("highcharts-legend-box").attr({
                    r: k.borderRadius
                }).add(d), t.isNew = !0);
                t.attr({
            ...
            handleOverflow: function (a) {
                ...
                a > c && !1 !== t.enabled ? (this.clipHeight = n = Math.max(c - 20 - this.titleHeight - y, 0), this.currentPage = d(this.currentPage, 1), this.fullHeight =
                    a, f(B, function (a, b) {
                        ...
                        c !== g && (g = c)
                    }), l || (l = b.clipRect = m.clipRect(0, y, 9999, 0), b.contentGroup.clip(l)), v(n), p || (this.nav = p = m.g().attr({
                        zIndex: 1
                    }).add(this.group), this.up = m.symbol("triangle", 0, 0, w, w).on("click", function () {
                        b.scroll(-1, k)
                        ...
                        this.down = m.symbol("triangle-down", 0, 0, w, w).on("click", function () {
                            b.scroll(1, k)
                        }).add(p)), b.scroll(0), a = c) : p && (v(), p.hide(), this.scrollGroup.attr({
                            translateY: 1
                        }), this.clipHeight = 0);
                return a
            },
            scroll: function (a, b) {
                ...
                }), b = -d[a - 1] + this.initialItemY, this.scrollGroup.animate({
                    translateY: b
                }), this.currentPage =
        ...
        E.prototype = {
            ...
            redraw: function (b) {
                ...
                for (this.layOutTitles(); q--;)
                    ...
                    for (q = l; q--;) b = k[q], b.options.stacking && (b.isDirty = !0);
                n(k, function (a) {
            ...
            layOutTitles: function (a) {
                ...
                n(["title", "subtitle"], function (a) {
                    var c = this[a],
                        e = this.options[a],
                        d;
                    c && (d = e.style.fontSize, d = k.fontMetrics(d, c).b, c.css({
                        width: (e.width || g.width + e.widthAdjust) + "px"
                    }).align(y({
                        y: b + d + ("title" === a ? -3 : 2)
                    }, e), !1, "spacingBox"), e.floating || e.verticalAlign || (b = Math.ceil(b + c.getBBox().height)))
                }, this);
            ...
            drawChartBox: function () {
                ...
                A = "animate";
                d || (A = "attr", this.plotBorder = d = b.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                d.attr({
            ...
            renderLabels: function () {
                ...
                b.items && n(b.items, function (c) {
                    var g = y(b.style, c.style),
                        ...
                        e = K(g.top) + a.plotTop + 12;
                    delete g.left;
                    delete g.top;
                    a.renderer.text(c.html, k, e).attr({
                        zIndex: 2
                    }).css(g).add()
                })
            },
        ...
        D.prototype = {
            ...
            optionsToObject: function (a) {
                var c = {},
                    ...
                    b = 0,
                    l = 0;
                if (v(a) || null === a) c[h[0]] = a;
                else if (p(a))
                    for (!f && a.length > m && (d = typeof a[0], "string" === d ? c.name = a[0] : "number" === d && (c.x = a[0]), b++); l < m;) f && void 0 ===
                        a[b] || (c[h[l]] = a[b]), b++ , l++;
        ...
        a.Series = a.seriesType("line", null, {
            ...
            turboThreshold: 1E3
                    ...
                    if (!1 !== f && n && h === n && !k.cropped && !k.hasGroupedData && k.visible) u(c, function (a, b) {
                        ...
                        if (p && n > p) {
                            ...
                            if (m(l))
                                ...
                                if (F)
                                    for (d = 0; d < n; d++) l = c[d], x[d] = l[0], A[d] = l.slice(1, F + 1);
                                else
                                    for (d = 0; d < n; d++) l = c[d], x[d] = l[0], A[d] = l[1];
                            else a.error(12)
                        } else
                            for (d = 0; d < n; d++) void 0 !== c[d] && (l = {
                                series: k
                            }, k.pointClass.prototype.applyOptions.apply(l, [c[d]]), k.updateParallelArrays(l, d));
                        b(A[0]) && a.error(14, !0);
                        k.data = [];
                ...
                processData: function (b) {
                    ...
                    if (r && this.sorted && !l && (!h || e > h || this.forceCrop))
                        if (c[e - 1] < t || c[0] > p) c = [],
                            k = [];
                        else if (c[0] < t || c[e - 1] > p) d = this.cropData(this.xData, this.yData, t, p), c = d.xData, k = d.yData, d = d.start, g = !0;
                ...
                getExtremes: function (a) {
                    ...
                    e = a.length;
                    for (r = 0; r < e; r++)
                        if (n = c[r], l = a[r], h = (m(l, !0) || t(l)) && (!b.isLog || l.length || 0 < l), n = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[r + 1] || n) >= d && (c[r - 1] || n) <= f, h && n)
                            if (h = l.length)
                                for (; h--;) null !== l[h] && (k[g++] =
                                    l[h]);
                            else k[g++] = l;
                ...
                setClip: function (a) {
                    var b = this.chart,
                        ...
                        h = b[f],
                        m = b[f + "m"];
                    h || (a && (d.width = 0, b[f + "m"] = m = e.clipRect(-99, k ? -b.plotLeft : -b.plotTop, 99, k ? b.chartWidth : b.chartHeight)), b[f] = h = e.clipRect(d), h.count = {
                        length: 0
                    });
                ...
                drawPoints: function () {
                    var a = this.points,
                        ...
                        h, n, r, l, t = this.markerGroup,
                        q = z(f.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx > 2 * f.radius);
                    if (!1 !== f.enabled || this._hasPointMarkers)
                        for (e = a.length; e--;) d = a[e], c = d.plotY, g = d.graphic, h = d.marker || {}, n = !!d.marker, r = q && void 0 === h.enabled || h.enabled, l = d.isInside, r && m(c) && null !== d.y ? (c = z(h.symbol, this.symbol), d.hasImage = 0 === c.indexOf("url"), r = this.markerAttribs(d, d.selected && "select"),
                ...
                getGraphPath: function (a, b, c) {
                    ...
                    u(a, function (d, n) {
                        ...
                        d.isNull && !l(b) && 0 < n ? m = !k.connectNulls : d.isNull && !b ? m = !0 : (0 === n || m ? n = ["M", d.plotX, d.plotY] : e.getPointSpline ? n = e.getPointSpline(a, d, n) : g ? (n = 1 === g ? ["L", q.plotX,
                            t
                        ] : 2 === g ? ["L", (q.plotX + r) / 2, q.plotY, "L", (q.plotX + r) / 2, t] : ["L", r, q.plotY], n.push("L", r, t)) : n = ["L", r, t], h.push(d.x), g && h.push(d.x), f.push.apply(f, n), m = !1)
                    });
                    f.xMap = h;
                ...
                plotGroup: function (a, b, c, e, d) {
                    var g = this[a],
                        k = !g;
                    k && (this[a] = g = this.chart.renderer.g(b).attr({
                        zIndex: e || .1
                ...
                redraw: function () {
                    ...
                    c && (a.inverted && c.attr({
                        ...
                        translateX: z(e &&
                            e.left, a.plotLeft),
                        translateY: z(d && d.top, a.plotTop)
                    }));
                    this.translate();
                    this.render();
                ...
                buildKDTree: function () {
                    function a(c, e, g) {
                        ...
                        if (k = c && c.length) return d = b.kdAxisArray[e % g], c.sort(function (a, b) {
                            ...
                            2), {
                                point: c[k],
                                left: a(c.slice(0, k), e + 1, g),
                                right: a(c.slice(k + 1), e + 1, g)
                            }
                    }
                    var b = this,
                        c = b.kdDimensions;
    ...
    (function (a) {
        ...
        D.prototype = {
            ...
            render: function (a) {
                var d = this.options,
                    c = d.format,
                    c = c ? v(c, this) : d.formatter.call(this);
                this.label ?
                    this.label.attr({
                        text: c,
                        visibility: "hidden"
        ...
        C.prototype.buildStacks = function () {
            var a = this.series,
                d, c = l(this.options.reversedStacks,
                    !0),
                f = a.length,
                h;
            if (!this.isXAxis) {
                ...
                if (this.usePercentage)
                    for (h = 0; h < f; h++) a[h].setPercentStacks()
            }
        };
        ...
        C.prototype.resetStacks = function () {
            ...
            if (!this.isXAxis)
                for (d in a)
                    for (c in a[d]) a[d][c].touched < this.stacksTouched ? (a[d][c].destroy(), delete a[d][c]) : (a[d][c].total = null, a[d][c].cum = null)
        };
    ...
    (function (a) {
        ...
        l(a.Chart.prototype, {
            ...
            showLoading: function (a) {
                ...
                e || (b.loadingDiv = e = I("div", {
                    className: "highcharts-loading highcharts-loading-hidden"
                }, null, b.container), b.loadingSpan = I("span", {
            ...
            update: function (a, b) {
                ...
                if (k) {
                    ...
                    for (e in k) k.hasOwnProperty(e) && (-1 !== d("chart." + e, this.propsRequireUpdateSeries) && (n = !0), -1 !== d(e, this.propsRequireDirtyBox) && (this.isDirtyBox = !0));
                    "style" in k && this.renderer.setStyle(k.style)
                }
                for (e in a) {
                    if (this[e] && "function" === typeof this[e].update) this[e].update(a[e], !1);
                    else if ("function" === typeof this[h[e]]) this[h[e]](a[e]);
        ...
        l(b.prototype, {
            addPoint: function (a,
                ...
                p = g.x;
                q = r.length;
                if (this.requireSorting && p < r[q - 1])
                    for (l = !0; q && r[q - 1] > p;) q--;
            ...
            threshold: 0
                ...
                getStackPoints: function () {
                    var a = [],
                        ...
                        t = u.series,
                        m = t.length,
                        b, q = I(u.options.reversedStacks,
                            !0) ? 1 : -1,
                        z, F;
                        ...
                        C(f, function (e, n) {
                            ...
                            if (c[e] && !c[e].isNull) a.push(c[e]), C([-1, 1], function (a) {
                                var h = 1 === a ? "rightNull" : "leftNull",
                                    ...
                                    t = d[f[n + a]];
                                if (t)
                                    for (z = y; 0 <= z && z < m;) r = t.points[z], r || (z === y ? c[e][h] = !0 : b[z] && (k = d[e].points[z]) && (l -= k[1] - k[0])), z += q;
                ...
                getGraphPath: function (a) {
                    var f = h.prototype.getGraphPath,
                        ...
                        t = [],
                        m = this.index,
                        b, q = d.stacks[this.stackKey],
                        z = l.threshold,
                        F = d.getThreshold(l.threshold),
                        e, l = l.connectNulls || "percent" === p,
                        r = function (c, e, f) {
                            var k = a[c];
                            c = p && q[k.x].points[m];
                            var h = k[f + "Null"] || 0;
                            ...
                            void 0 !== n && (t.push({
                                ...
                                plotX: b,
                                plotY: null === l ? F : d.getThreshold(l),
                                doCurve: !1
                            }))
                        };
                    a = a || this.points;
                    ...
                    for (c = 0; c < a.length; c++)
                        if (n = a[c].isNull, b = I(a[c].rectPlotX, a[c].plotX), e = I(a[c].yBottom, F), !n || l) l || r(c, c - 1, "left"), n && !p && l || (t.push(a[c]), y.push({
                            x: c,
                            plotX: b,
                            plotY: e
                        })), l || r(c, c + 1, "right");
                ...
                drawGraph: function () {
                    ...
                    C(u, function (d) {
                        ...
                        h ? (h.endX = f.xMap, h.animate({
                            d: f
                        })) : (h = a[c] = a.chart.renderer.path(f).addClass(d[1]).attr({
                            fill: I(d[3],
                                D(d[2]).setOpacity(I(l.fillOpacity, .75)).get()),
                            zIndex: 0
        ...
        l("column", "line", {
            ...
            borderColor: "#ffffff"
                ...
                translate: function () {
                    ...
                    G(a.points, function (d) {
                        ...
                        d.tooltipPos = c.inverted ? [l.len + l.pos - c.plotLeft -
                            h, a.xAxis.len - k - n / 2, t
                        ] : [k + n / 2, h + l.pos - c.plotTop, t];
                        d.shapeType = "rect";
                ...
                pointAttribs: function (a, c) {
                    ...
                    var m = h["stroke-width"] || "borderWidth",
                ...
                drawPoints: function () {
                    ...
                    G(a.points, function (b) {
                        ...
                        if (h(b.plotY) &&
                            null !== b.y) {
                            m = b.shapeArgs;
                            if (d) d[c.pointCount < t ? "animate" : "attr"](f(m));
                            else b.graphic = d = p[b.shapeType](m).attr({
            ...
            states: {
                ...
                updateTotals: function () {
                    var a, d = 0,
                        f = this.points,
                        h = f.length,
                        m, b = this.options.ignoreHiddenPoint;
    ...
    (function (a) {
        ...
        c.prototype.drawDataLabels = function () {
            var a = this,
                ...
                r, p, A = u(b.defer, !0),
                k = a.chart.renderer;
            if (b.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(b), p = a.plotGroup("dataLabelsGroup", "data-labels", A && !e ? "hidden" : "visible", b.zIndex || 6), A && (p.attr({
                opacity: +e
            }), e || D(a, "afterAnimate", function () {
                a.visible && p.show(!0);
                p[c.animation ? "animate" : "attr"]({
                    opacity: 1
                }, {
                        duration: 200
                    })
                ...
                if (m && !d) e.dataLabel = m.destroy();
                    ...
                    if (m) G(r) ? (m.attr({
                        text: r
                    }), F = !1) : (e.dataLabel = m = m.destroy(), t && (e.connector = t.destroy()));
                    else if (G(r)) {
                        m = {
        ...
        c.prototype.alignDataLabel = function (a, c, b, d, f) {
            ...
            v && (k = b.style.fontSize, k = m.renderer.fontMetrics(k, c).b, d = h({
                ...
                d.height
            }, c[f ? "attr" : "animate"](e).attr({
                align: t
            }), l = (q + 720) % 360, l = 180 < l && 360 > l, "left" === t ? e.y -= l ? p.height : 0 : "center" === t ? (e.x -= p.width / 2, e.y -= p.height / 2) : "right" === t && (e.x -= p.width, e.y -= l ? 0 : p.height)) : (c.align(b, null, d), e = c.alignAttr), z ? this.justifyDataLabel(c, b, e, p, d, f) : u(b.crop, !0) && (v = m.isInsidePlot(e.x, e.y) && m.isInsidePlot(e.x + p.width, e.y + p.height)), b.shape && !q && c.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
            v || (c.attr({
        ...
        n.pie && (n.pie.prototype.drawDataLabels = function () {
            ...
            d.visible && (l.enabled || d._hasPointLabels) && (c.prototype.drawDataLabels.apply(d), I(f, function (a) {
                ...
                var f, m, q = c.length,
                    t, u, F;
                if (q)
                    for (d.sortByAngle(c, e - .5), 0 < k && (f = Math.max(0, D - y - k), m = Math.min(D + y + k, h.plotHeight), t = p(c, function (a) {
                        if (a.dataLabel) return F =
                            a.dataLabel.getBBox().height || 21, {
                                target: a.labelPos[1] - f + F / 2,
                                size: F,
                                rank: a.y
                            }
            ...
            I(this.points, function (a) {
                ...
                c && a.visible && ((a = c._pos) ?
                    (c.attr(c._attr), c[c.moved ? "animate" : "attr"](a), c.moved = !0) : c && c.attr({
                        y: -9999
                    }))
            })
    ...
    (function (a) {
        ...
        D.prototype.hideOverlappingLabels = function (a) {
            var f = a.length,
                h, v, l, u, d, c, n, y, t, m = function (a, c, d, f, e, h, l, m) {
            ...
            for (v = 0; v < f; v++)
                for (l = a[v], h = v + 1; h < f; ++h)
                    if (u = a[h], l && u && l.placed && u.placed && 0 !==
    ...
    (function (a) {
        ...
        a = a.TrackerMixin = {
            ...
            drawTrackerGraph: function () {
                ...
                if (f && !c)
                    for (g = f + 1; g--;) "M" === d[g] && d.splice(g + 1, 0, d[g + 1] - n, d[g + 2], "L"), (g && "M" === d[g] || g === f) && d.splice(g, 0, "L", d[g - 2] + n, d[g - 1]);
                q ? q.attr({
                    d: d
            ...
            pan: function (a, b) {
                ...
                p("xy" === b ? [1, 0] : [1], function (b) {
                    ...
                    var e = b.horiz,
                        ...
                        g = l - Math.max(g.dataMax, g.max);
                    b.series.length && 0 > k && 0 > g && (b.setExtremes(h, l, !1, !1, {
                        trigger: "pan"
                    }), d = !0);
                    c[e] = f
                });
        ...
        v(m.prototype, {
            ...
            setState: function (a, b) {
                ...
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (p || m && !1 === n.enabled) || a && q.states &&
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(e.pointAttribs(this, a)), z && this.graphic.animate(z, t(u.options.chart.animation, n.animation, l.animation)), g && g.hide();
                    else {
                        if (a && n) {
                            l = q.symbol || e.symbol;
                    ...
                    } (c = h.halo) && c.size ? (y || (e.halo = y = u.renderer.path().add(F ? e.markerGroup : e.group)), y[b ? "animate" : "attr"]({
                        d: this.haloPath(c.size)
                    }), y.attr({
                        "class": "highcharts-halo highcharts-color-" + t(this.colorIndex, e.colorIndex)
                    }), y.point = this, y.attr(v({
                        fill: this.color || e.color,
                        "fill-opacity": c.opacity,
                        zIndex: -1
                    }, c.attributes))) : y && y.point &&
                    y.point.haloPath && y.animate({
        ...
        v(b.prototype, {
            ...
            setState: function (a) {
                ...
                }), b.state = a, !f[a] || !1 !== f[a].enabled) && (a && (h = f[a].lineWidth || h + (f[a].lineWidthPlus || 0)), d && !d.dashstyle))
                    for (f = {
                        "stroke-width": h
                    }, d.attr(f); b["zone-graph-" +
    ...
    (function (a) {
        ...
        D.prototype.currentOptions = function (a) {
            function h(a, d, c) {
                var l, p;
                for (l in a)
                    if (-1 < G(l, ["series", "xAxis", "yAxis"]))
                        for (a[l] = f(a[l]), c[l] = [], p = 0; p < a[l].length; p++) c[l][p] = {}, h(a[l][p], d[l][p], c[l][p]);
        ...
        v(l.prototype, {
            ...
            drawCrosshair: function (a, b) {
                ...
                b && (h = this.toPixels(b[b.series.colorKey]), h < f ? h = f - 2 : h > f + e && (h = f + e + 2), b.plotX = h, b.plotY = this.len - h, k.prototype.drawCrosshair.call(this, a, b),
                    b.plotX = d, b.plotY = c, this.cross && (this.cross.addClass("highcharts-coloraxis-marker").add(this.legendGroup), this.cross.attr({
            ...
            translate: function () {
                ...
                r(this.points, function (f) {
                    var a = (c.colsize || 1) / 2,
                        ...
                        a = l(Math.round(e.len - e.translate(f.x +
                            a, 0, 1, 0, 1)), -e.len, 2 * e.len),
...
(function (h) {
    ...
    (function (a) {
        ...
        a.downloadURL = function (d, a) {
            ...
            else if (void 0 !== c.download) c.href = d, c.download = a, c.target = "_blank", t.body.appendChild(c), c.click(), t.body.removeChild(c);
            else try {
                if (b = e.open(d, "chart"), void 0 === b || null === b) throw "Failed to open window";
            } catch (v) {
                e.location.href = d
            }
        };
        a.svgToDataUrl = function (d) {
            var a = -1 < u.userAgent.indexOf("WebKit") && 0 > u.userAgent.indexOf("Chrome");
            try {
                if (!a && 0 > u.userAgent.toLowerCase().indexOf("firefox")) return A.createObjectURL(new e.Blob([d], {
        ...
        a.downloadSVGLocal = function (d, f, c, b) {
            ...
            function l() {
                ...
                var c = r.getElementsByTagName("text"),
                    e, g = r.getElementsByTagName("svg")[0].style;
                y(c, function (a) {
            ...
            var k, m, p = !0,
                z, g = f.libURL || a.getOptions().exporting.libURL,
                r = t.createElement("div"),
                q = f.type || "image/png",
                n = (f.filename || "chart") + "." + ("image/svg+xml" === q ? "svg" : q.split("/")[1]),
                h = f.scale || 1,
                g = "/" !== g.slice(-1) ? g + "/" : g;
            if ("image/svg+xml" === q) try {
                u.msSaveOrOpenBlob ? (m = new MSBlobBuilder, m.append(d), k = m.getBlob("image/svg+xml")) : k = a.svgToDataUrl(d), a.downloadURL(k, n), b && b()
            } catch (x) {
                c()
            } else "application/pdf" ===
                q ? e.jsPDF && e.svgElementToPdf ? l() : (p = !0, w(g + "jspdf.js", function () {
                    w(g + "rgbcolor.js", function () {
                        w(g + "svg2pdf.js", function () {
                            l()
                        })
                    })
                })) : (k = a.svgToDataUrl(d), z = function () {
                    try {
                        A.revokeObjectURL(k)
                    } catch (x) { }
                }, a.imageToDataUrl(k, q, {}, h, function (d) {
                    try {
                    ...
                    var f = t.createElement("canvas"),
                        v = f.getContext("2d"),
                        l = d.match(/^<svg[^>]*width\s*=\s*\"?(\d+)\"?[^>]*>/)[1] * h,
                        k = d.match(/^<svg[^>]*height\s*=\s*\"?(\d+)\"?[^>]*>/)[1] * h,
                        m = function () {
                            v.drawSvg(d, 0, 0, l, k);
                            try {
                                a.downloadURL(u.msSaveOrOpenBlob ? f.msToBlob() : f.toDataURL(q), n), b && b()
                            } catch (E) {
                                c()
                            } finally {
                                z()
                    ...
                    f.width = l;
                    f.height = k;
                    e.canvg ? m() : (p = !0, w(g + "rgbcolor.js", function () {
        ...
        a.Chart.prototype.getSVGForLocalExport = function (d, f, c, b) {
            ...
            try {
                if (l.length)
                    for (g = 0, r = l.length; g < r; ++g) h = l[g], a.imageToDataUrl(h.getAttributeNS("http://www.w3.org/1999/xlink", "href"), "image/png", {
                        imageElement: h
                    }, d.scale, q, c, c, c);
        ...
        a.Chart.prototype.exportChartLocal = function (d, e) {
            ...
            (B && "image/svg+xml" !== b.type || "application/pdf" === b.type) && c.container.getElementsByTagName("image").length ? f() : c.getSVGForLocalExport(b, e, f, function (c) {
                -1 < c.indexOf("\x3cforeignObject") && "image/svg+xml" !== b.type ? f() : a.downloadSVGLocal(c, b, f)
            })
        };
...
! function (a) {
    ...
    var b = a.each,
        c = a.pick,
        d = a.seriesTypes,
        e = void 0 !== document.createElement("a").download;
    a.setOptions({
        lang: {
            downloadCSV: "Download CSV",
            downloadXLS: "Download XLS",
            viewData: "View data tab1le"
        }
    }), a.Chart.prototype.getDataRows = function () {
        var e, i, k, l, m, d = (this.options.exporting || {}).csv || {},
            f = this.xAxis,
            g = {},
            h = [],
            j = [],
            n = d.dateFormat || "%Y-%m-%d %H:%M:%S",
            o = d.columnHeaderFormatter || function (b, c, d) {
                return b instanceof a.Axis ? b.options.title && b.options.title.text || (b.isDatetimeAxis ? "DateTime" : "Category") : b ? b.name + (d > 1 ? " (" + c + ")" : "") : "Category"
            },
            p = [];
        k = 0, b(this.series, function (d) {
            var q, e = d.options.keys,
                h = e || d.pointArrayMap || ["y"],
                i = h.length,
                l = d.requireSorting,
                m = {},
                n = a.inArray(d.xAxis, f);
            if (b(h, function (a) {
                m[a] = d[a + "Axis"] && d[a + "Axis"].categories || []
            }), !1 !== d.options.includeInCSVExport && !1 !== d.visible) {
                for (a.find(p, function (a) {
                    return a[0] === n
                }) || p.push([n, k]), q = 0; q < i;) j.push(o(d, h[q], h.length)), q += 1;
                b(d.points, function (a, b) {
                    var f, j, e = l ? a.x : b;
                    for (q = 0, g[e] || (g[e] = [], g[e].xValues = []), g[e].x = a.x, g[e].xValues[n] = a.x, d.xAxis && "name" !== d.exportKey || (g[e].name = a.name); q < i;) f = h[q], j = a[f], g[e][k + q] = c(m[f][j], j), q += 1
                }), k += q
            }
        });
        for (l in g) g.hasOwnProperty(l) && h.push(g[l]);
        var r, s;
        for (i = [j], k = p.length; k--;) r = p[k][0], s = p[k][1], e = f[r], h.sort(function (a, b) {
            return a.xValues[r] - b.xValues[r]
        }), m = o(e), i[0].splice(s, 0, m), b(h, function (b) {
            var d = b.name;
            d || (e.isDatetimeAxis ? (b.x instanceof Date && (b.x = b.x.getTime()), d = a.dateFormat(n, b.x)) : d = e.categories ? c(e.names[b.x], e.categories[b.x], b.x) : b.x), b.splice(s, 0, d)
        });
        return i = i.concat(h)
        ...
        var c = "",
            ...
            f = e.itemDelimiter || ",",
            g = e.lineDelimiter || "\n";
        return b(d, function (b, e) {
            for (var h = "", i = b.length, j = a ? 1.1.toLocaleString()[1] : "."; i--;) h = b[i], "string" == typeof h && (h = '"' + h + '"'), "number" == typeof h && "," === j && (h = h.toString().replace(".", ",")), b[i] = h;
            c += b.join(f), e < d.length - 1 && (c += g)
        }), c
        ...
        return b(d, function (b, d) {
            ...
            for (c += "<tr>", g = 0; g < b.length; g += 1) f = b[g], "number" == typeof f ? (f = f.toString(), "," === h && (f = f.replace(".", h)), c += "<" + e + ' class="number">' + f + "</" + e + ">") : c += "<" + e + ">" + (void 0 === f ? "" : f) + "</" + e + ">";
            c += "</tr>", d || (c += "</thead><tbody>")
        }), c += "</tbody></tab1le>"
    }, a.Chart.prototype.downloadCSV = function () {
        var a = this.getCSV(!0);
        f(this, "data:text/csv,\ufeff" + encodeURIComponent(a), "csv", a, "text/csv")
        ...
        f(this, "data:application/vnd.ms-excel;base64," + function (a) {
            return window.btoa(unescape(encodeURIComponent(a)))
        }(b), "xls", b, "application/vnd.ms-excel")
    }, a.Chart.prototype.viewData = function () {
        this.dataTableDiv || (this.dataTableDiv = document.createElement("div"), this.dataTableDiv.className = "highcharts-data-tab1le", this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling)), this.dataTableDiv.innerHTML = this.getTable()
        ...
        }), d.map && (d.map.prototype.exportKey = "name"), d.mapbubble && (d.mapbubble.prototype.exportKey = "name"), d.treemap && (d.treemap.prototype.exportKey = "name")
});
...
(function ($) {
    $.extend({
        tab1lesorter: new
            function () {
                ...
                function buildParserCache(tab1le, $headers) {
                    if (tab1le.config.debug) {
                        var parsersDebug = "";
                    }
                    if (tab1le.tBodies.length == 0) return;
                    var rows = tab1le.tBodies[0].rows;
                    if (rows[0]) {
                        var list = [],
                            cells = rows[0].cells,
                            l = cells.length;
                        for (var i = 0; i < l; i++) {
                            ...
                            } else if ((tab1le.config.headers[i] && tab1le.config.headers[i].sorter)) {
                                p = getParserById(tab1le.config.headers[i].sorter);
                            }
                            if (!p) {
                                p = detectParserForColumn(tab1le, rows, -1, i);
                            }
                            if (tab1le.config.debug) {
                ...
                function detectParserForColumn(tab1le, rows, rowIndex, cellIndex) {
                    ...
                    while (nodeValue == '' && keepLooking) {
                        ...
                        if (rows[rowIndex]) {
                            ...
                            nodeValue = trimAndGetNodeText(tab1le.config, node);
                            if (tab1le.config.debug) {
                    ...
                    for (var i = 1; i < l; i++) {
                        if (parsers[i].is(nodeValue, tab1le, node)) {
                            return parsers[i];
                        }
                    }
                    return parsers[0];
                ...
                function buildCache(tab1le) {
                    if (tab1le.config.debug) {
                        var cacheTime = new Date();
                    }
                    var totalRows = (tab1le.tBodies[0] && tab1le.tBodies[0].rows.length) || 0,
                        totalCells = (tab1le.tBodies[0].rows[0] && tab1le.tBodies[0].rows[0].cells.length) || 0,
                        parsers = tab1le.config.parsers,
                        cache = {
                            row: [],
                            normalized: []
                        };
                    for (var i = 0; i < totalRows; ++i) {
                        var c = $(tab1le.tBodies[0].rows[i]),
                            cols = [];
                        if (c.hasClass(tab1le.config.cssChildRow)) {
                            cache.row[cache.row.length - 1] = cache.row[cache.row.length - 1].add(c);
                            continue;
                        }
                        cache.row.push(c);
                        for (var j = 0; j < totalCells; ++j) {
                            cols.push(parsers[j].format(getElementText(tab1le.config, c[0].cells[j]), tab1le, c[0].cells[j]));
                        }
                ...
                function appendToTable(tab1le, cache) {
                    if (tab1le.config.debug) {
                    ...
                    var c = cache,
                        ...
                        tab1leBody = $(tab1le.tBodies[0]),
                        rows = [];
                    for (var i = 0; i < totalRows; i++) {
                        var pos = n[i][checkCell];
                        rows.push(r[pos]);
                        if (!tab1le.config.appender) {
                            var l = r[pos].length;
                            for (var j = 0; j < l; j++) {
                                tab1leBody[0].appendChild(r[pos][j]);
                            }
                        }
                    }
                    if (tab1le.config.appender) {
                        tab1le.config.appender(tab1le, rows);
                    }
                    rows = null;
                    if (tab1le.config.debug) {
                        benchmark("Rebuilt tab1le:", appendTime);
                    }
                    applyWidget(tab1le);
                    setTimeout(function () {
                        $(tab1le).trigger("sortEnd");
                    }, 0);
                };

                function buildHeaders(tab1le) {
                    if (tab1le.config.debug) {
                        var time = new Date();
                    }
                    var meta = ($.metadata) ? true : false;
                    var header_index = computeTableHeaderCellIndexes(tab1le);
                    $tab1leHeaders = $(tab1le.config.selectorHeaders, tab1le).each(function (index) {
                        this.column = header_index[this.parentNode.rowIndex + "-" + this.cellIndex];
                        this.order = formatSortingOrder(tab1le.config.sortInitialOrder);
                        this.count = this.order;
                        if (checkHeaderMetadata(this) || checkHeaderOptions(tab1le, index)) this.sortDisabled = true;
                        if (checkHeaderOptionsSortingLocked(tab1le, index)) this.order = this.lockedOrder = checkHeaderOptionsSortingLocked(tab1le, index);
                        if (!this.sortDisabled) {
                            var $th = $(this).addClass(tab1le.config.cssHeader);
                            if (tab1le.config.onRenderHeader) tab1le.config.onRenderHeader.apply($th);
                        }
                        tab1le.config.headerList[index] = this;
                    });
                    if (tab1le.config.debug) {
                        benchmark("Built headers:", time);
                        log($tab1leHeaders);
                    }
                    return $tab1leHeaders;
                };
                ...
                function checkCellColSpan(tab1le, rows, row) {
                    var arr = [],
                        r = tab1le.tHead.rows,
                        c = r[row].cells;
                    for (var i = 0; i < c.length; i++) {
                        var cell = c[i];
                        if (cell.colSpan > 1) {
                            arr = arr.concat(checkCellColSpan(tab1le, headerArr, row++));
                        } else {
                            if (tab1le.tHead.length == 1 || (cell.rowSpan > 1 || !r[row + 1])) {
                                arr.push(cell);
                            }
                        }
                    }
                ...
                function checkHeaderOptions(tab1le, i) {
                    if ((tab1le.config.headers[i]) && (tab1le.config.headers[i].sorter === false)) {
                        return true;
                    };
                    return false;
                }

                function checkHeaderOptionsSortingLocked(tab1le, i) {
                    if ((tab1le.config.headers[i]) && (tab1le.config.headers[i].lockedOrder)) return tab1le.config.headers[i].lockedOrder;
                    return false;
                }

                function applyWidget(tab1le) {
                    var c = tab1le.config.widgets;
                    var l = c.length;
                    for (var i = 0; i < l; i++) {
                        getWidgetById(c[i]).format(tab1le);
                    }
                }
                ...
                function setHeadersCss(tab1le, $headers, list, css) {
                ...
                function fixColumnWidth(tab1le, $headers) {
                    var c = tab1le.config;
                    if (c.widthFixed) {
                        var colgroup = $('<colgroup>');
                        $("tr:first td", tab1le.tBodies[0]).each(function () {
                            colgroup.append($('<col>').css('width', $(this).width()));
                        });
                        $(tab1le).prepend(colgroup);
                    };
                }

                function updateHeaderSortCount(tab1le, sortList) {
                    var c = tab1le.config,
                        l = sortList.length;
                    for (var i = 0; i < l; i++) {
                        var s = sortList[i],
                ...
                function multisort(tab1le, sortList, cache) {
                    if (tab1le.config.debug) {
                    ...
                    for (var i = 0; i < l; i++) {
                        ...
                        var s = (tab1le.config.parsers[c].type == "text") ? ((order == 0) ? makeSortFunction("text", "asc", c) : makeSortFunction("text", "desc", c)) : ((order == 0) ? makeSortFunction("numeric", "asc", c) : makeSortFunction("numeric", "desc", c));
                        var e = "e" + i;
                        dynamicExp += "var " + e + " = " + s;
                ...
                function sortText(a, b) {
                    if (tab1le.config.sortLocaleCompare) return a.localeCompare(b);
                    return ((a < b) ? -1 : ((a > b) ? 1 : 0));
                };

                function sortTextDesc(a, b) {
                    if (tab1le.config.sortLocaleCompare) return b.localeCompare(a);
                ...
                this.construct = function (settings) {
                    return this.each(function () {
                        ...
                        var $this, $document, $headers, cache, config, shiftDown = 0,
                            sortOrder;
                        this.config = {};
                        config = $.extend(this.config, $.tab1lesorter.defaults, settings);
                        $this = $(this);
                        $.data(this, "tab1lesorter", config);
                ...
                this.clearTableBody = function (tab1le) {
                    if ($.browser.msie) {
                        function empty() {
                            while (this.firstChild) this.removeChild(this.firstChild);
                        }
                        empty.apply(tab1le.tBodies[0]);
                    } else {
                        tab1le.tBodies[0].innerHTML = "";
                    }
                };
            }
    });
    $.fn.extend({
        tab1lesorter: $.tab1lesorter.construct
    });
    var ts = $.tab1lesorter;
    ts.addParser({
        id: "text",
    ...
    ts.addParser({
        id: "digit",
        is: function (s, tab1le) {
            var c = tab1le.config;
            return $.tab1lesorter.isDigit(s, c);
        },
        format: function (s) {
            return $.tab1lesorter.formatFloat(s);
        },
        type: "numeric"
    });
    ts.addParser({
        ...
        format: function (s) {
            return $.tab1lesorter.formatFloat(s.replace(new RegExp(/[£$€]/g), ""));
        },
        type: "numeric"
    });
    ts.addParser({
        ...
        format: function (s) {
            ...
            return $.tab1lesorter.formatFloat(r);
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.tab1lesorter.formatFloat((s != "") ? new Date(s.replace(new RegExp(/-/g), "/")).getTime() : "0");
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.tab1lesorter.formatFloat(new Date(s).getTime());
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.tab1lesorter.formatFloat(new Date("2000/01/01 " + s).getTime());
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addWidget({
        id: "zebra",
        format: function (tab1le) {
            if (tab1le.config.debug) {
                var time = new Date();
            }
            var $tr, row = -1,
                odd;
            $("tr:visible", tab1le.tBodies[0]).each(function (i) {
                $tr = $(this);
                if (!$tr.hasClass(tab1le.config.cssChildRow)) row++;
                odd = (row % 2 == 0);
                $tr.removeClass(tab1le.config.widgetZebra.css[odd ? 0 : 1]).addClass(tab1le.config.widgetZebra.css[odd ? 1 : 0])
            });
            if (tab1le.config.debug) {
                $.tab1lesorter.benchmark("Applying Zebra widget", time);
            }
        }
    });
})(jQuery);
        ...
        5: [function (e, t, n) {
            function i(e) {
                ...
                if ("SELECT" === e.nodeName) e.focus(), t = e.value;
                    ...
                    e.hasAttribute("contenteditab1le") && e.focus();
                    ...
                    a = function () {
                        function e(e, t) {
                            for (var n = 0; n < t.length; n++) {
                                var i = t[n];
                                i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writab1le = !0), Object.defineProperty(e, i.key, i)
                            }
                        }
...
$(function () {
    ...
    if ($('.mqc_tab1le').length > 0) {

        // Enable tab1lesorter on MultiQC tab1les
        var strip_non_numeric = function (node) {
            return node.innerText.replace(/[^\d.-]/g, '');
        }
        $('.mqc_tab1le').tab1lesorter({
            sortInitialOrder: 'desc',
            textExtraction: strip_non_numeric
        });

        // Update tab1lesorter if samples renamed
        $(document).on('mqc_renamesamples', function (e, f_texts, t_texts, regex_mode) {
            $('.mqc_tab1le').trigger('update');
        });

        // Copy tab1le contents to clipboard
        var clipboard = new Clipboard('.mqc_tab1le_copy_btn');
        clipboard.on('success', function (e) {
            e.clearSelection();
        });
        $('.mqc_tab1le_copy_btn').click(function () {
            var btn = $(this);
            btn.addClass('active').html('<span class="glyphicon glyphicon-copy"></span> Copied!');
            setTimeout(function () {
                btn.removeClass('active').html('<span class="glyphicon glyphicon-copy"></span> Copy tab1le');
            }, 2000);
        });

        // Make tab1le headers fixed when tab1le body scrolls (use CSS transforms)
        // http://stackoverflow.com/a/25902860/713980
        $('.mqc-tab1le-responsive').scroll(function () {
            $(this).find('thead').css('transform', "translate(0," + $(this).scrollTop() + "px)");
        });

        // Table header-specific bootstrap tooltips
        $('.mqc_tab1le_tooltip').tooltip({
            container: 'body'
        });

        // Expand tab1les to full height
        $('.mqc-tab1le-expand').click(function () {
            if ($(this).find('span').hasClass('glyphicon-chevron-down')) {
                $(this).parent().find('.mqc-tab1le-responsive').css('max-height', 'none');
                $(this).find('span').removeClass('glyphicon-chevron-down').addClass('glyphicon-chevron-up');
            } else {
                $(this).parent().find('.mqc-tab1le-responsive').css('max-height', '400px');
        ...
        /////// COLUMN CONFIG
        // show + hide columns
        $('.mqc_tab1le_col_visible').change(function () {
            var target = $(this).data('target');
            mqc_tab1le_col_updateVisible(target);
        });
        ...
        $('.mqc_configModal_bulkVisible').click(function (e) {
            ...
            $(target + '_configModal_tab1le tbody .mqc_tab1le_col_visible').prop('checked', visible);
            mqc_tab1le_col_updateVisible(target);
        });

        function mqc_tab1le_col_updateVisible(target) {
            $(target + '_configModal_tab1le .mqc_tab1le_col_visible').each(function () {
                var cclass = $(this).val();
                if ($(this).is(":checked")) {
                    $(target + ' .' + cclass).removeClass('hidden');
                    $(target + '_configModal_tab1le .' + cclass).removeClass('text-muted');
                } else {
                    $(target + ' .' + cclass).addClass('hidden');
                    $(target + '_configModal_tab1le .' + cclass).addClass('text-muted');
                }
            });
            // Hide empty rows
        ...
        // Make rows in MultiQC tab1les sortab1le
        $('.mqc_tab1le.mqc_sortab1le tbody').sortab1le({
            handle: '.sorthandle',
        ...
        $('.mqc_configModal_tab1le').on('sortstop', function (e, ui) {
            change_mqc_tab1le_col_order($(this));
        });
        $('.mqc_configModal_tab1le').bind('sortEnd', function () {
            change_mqc_tab1le_col_order($(this));
        });
        ...
        $(document).on('mqc_highlights', function (e, f_texts, f_cols, regex_mode) {
            $('.mqc_tab1le_sortHighlight').hide();
            $('.mqc_tab1le tbody th').removeClass('highlighted').removeData('highlight');
            $('.mqc_tab1le tbody th').each(function (i) {
                var th = $(this);
        ...
        // Sort MultiQC tab1les by highlight
        $('.mqc_tab1le_sortHighlight').click(function (e) {
            e.preventDefault();
            var target = $(this).data('target');
        ...
        // Rename samples
        $(document).on('mqc_renamesamples', function (e, f_texts, t_texts, regex_mode) {
            $(".mqc_tab1le tbody th").each(function () {
        ...
        $(document).on('mqc_hidesamples', function (e, f_texts, regex_mode) {
            ...
            $('.mqc_tab1le_numrows').each(function () {
                var tid = $(this).attr('id').replace('_numrows', '');
                $(this).text($('#' + tid + ' tbody tr:visible').length);
            });

            // Hide empty columns
            $('.mqc_tab1le').each(function () {
                var tab1le = $(this);
                var gsthidx = 0;
                tab1le.find("thead th, tbody tr td").show();
                tab1le.find("thead th").each(function () {
                    if (gsthidx == 0) {
                        gsthidx += 1;
                        return true;
                    }
                    var count = 0;
                    var empties = 0;
                    tab1le.find("tbody tr td:nth-child(" + (gsthidx + 2) + ")").filter(":visible").each(function () {
                        count += 1;
                        if ($(this).text() == '') {
                            empties += 1;
                        }
                    ...
                    if (count > 0 && count == empties) {
                        $(this).hide();
                        tab1le.find("tbody tr td:nth-child(" + (gsthidx + 2) + ")").hide();
                    }
                    gsthidx += 1;
                });
            });
            $('.mqc_tab1le_numcols').each(function () {
                var tid = $(this).attr('id').replace('_numcols', '');
                $(this).text($('#' + tid + ' thead th:visible').length - 1);
            });
        });

    } // End of check for tab1le

    // Table Scatter Modal
    $('#tab1leScatterForm').submit(function (e) {
        e.preventDefault();
    });
    $('.mqc_tab1le_makeScatter').click(function (e) {
        // Reset dropdowns
        if ($('#tab1leScatter_tid').val() != $(this).data('tab1le')) {
            $('#tab1leScatter_col1, #tab1leScatter_col2').html('<option value="">Select Column</option>');
            // Add columns to dropdowns
            $($(this).data('tab1le') + ' thead tr th').each(function (e) {
                var c_id = $(this).attr('id');
                if (c_id != undefined) {
                    var c_name = $(this).attr('data-namespace') + ': ' + $(this).text();
                    $('#tab1leScatter_col1, #tab1leScatter_col2').append('<option value="' + c_id + '">' + c_name + '</select>');
                }
            });
            $('#tab1leScatter_tid').val($(this).data('tab1le'));
            $('#tab1leScatterPlot').html('<small>Please select two tab1le columns.</small>').addClass('not_rendered');
        }
    });
    $('#tab1leScatterForm select').change(function (e) {
        var tid = $('#tab1leScatter_tid').val();
        var col1 = $('#tab1leScatter_col1').val().replace('header_', '');
        var col2 = $('#tab1leScatter_col2').val().replace('header_', '');
        var col1_name = $('#tab1leScatter_col1 option:selected').text();
        var col2_name = $('#tab1leScatter_col2 option:selected').text();
        ...
        if (col1 != '' && col2 != '') {
            $('#tab1leScatterPlot').html('<small>loading..</small>');
            ...
            // Get the data values
            mqc_plots['tab1leScatterPlot'] = {
                'plot_type': 'scatter',
                'config': {
                    'id': 'tab1leScatter_' + tid,
                    'title': plot_title,
                    'xlab': col1_name,
                    'ylab': col2_name,
                    'xmin': col1_min,
            ...
            $(tid + ' tbody tr').each(function (e) {
                ...
                if (!isNaN(parseFloat(val_1)) && isFinite(val_1) && !isNaN(parseFloat(val_2)) && isFinite(val_2)) {
                    mqc_plots['tab1leScatterPlot']['datasets'][0].push({
                        'name': s_name,
                        'x': parseFloat(val_1),
                        'y': parseFloat(val_2)
                    });
            ...
            if (Object.keys(mqc_plots['tab1leScatterPlot']['datasets'][0]).length > 0) {
                if (plot_scatter_plot('tab1leScatterPlot') == false) {
                    $('#tab1leScatterPlot').html('<small>Error: Something went wrong when plotting the scatter plot.</small>');
                    $('#tab1leScatterPlot').addClass('not_rendered');
                } else {
                    $('#tab1leScatterPlot').removeClass('not_rendered');
                }
            } else {
                $('#tab1leScatterPlot').html('<small>Error: No data pairs found for these columns.</small>');
                $('#tab1leScatterPlot').addClass('not_rendered');
            }
        } else {
            $('#tab1leScatterPlot').html('<small>Please select two tab1le columns.</small>');
            $('#tab1leScatterPlot').addClass('not_rendered');
        }
    });
...
function change_mqc_tab1le_col_order(tab1le) {
    ...
    $('#' + target + ' tr').each(function () {
        ...
        // Insert detached cells back in the order given in the sorted tab1le
...
$(function test_JS() {
            ...
            buttons: {
                contextButton: {
                    ...
                    onclick: function () {
                        ...
                        if (this.renderTo.id == 'tab1leScatterPlot') {
                            $('#tab1leScatterModal').modal('hide');
                        }
    ...
    $('.hc_switch_group button').click(function (e) {
        ...
        if (action == 'set_percent' || action == 'set_numbers') {
            ...
            if (ylab != undefined) {
                $('#' + target).highcharts().yAxis[0].setTitle({
                    text: ylab
                });
            }
            var xlab = $(this).data('xlab');
            if (xlab != undefined) {
                $('#' + target).highcharts().xAxis[0].setTitle({
                    text: xlab
                });
            }
        }
...
function plot_graph(target, ds, max_num) {
    if (mqc_plots[target] === undefined) {
        ...
        // Not recognised
            ...
            console.log('Did not recognise plot type: ' + mqc_plots[target]['plot_type']);
        }
    }
}
...
function plot_xy_line_graph(target, ds) {
    ...
    if (config['xDecimals'] === undefined) {
        config['xDecimals'] = true;
    }
    ...
    Highcharts.chart(target, {
        ...
        xAxis: {
            ...
            labels: {
                format: config['xLabelFormat'] ? config['xLabelFormat'] : '{value}'
            },
        ...
        yAxis: {
            ...
            labels: {
                format: config['yLabelFormat'] ? config['yLabelFormat'] : '{value}'
            },
    ...
    Highcharts.chart(target, {
        ...
        tooltip: {
            formatter: function () {
                ...
                var s = '<tab1le><tr><th colspan="' + colspan + '" style="font-weight:bold; text-decoration:underline;">' + this.x + '</th></tr>';
...
function plot_scatter_plot(target, ds) {
    ...
    if (config['marker_colour'] === undefined) {
        config['marker_colour'] = 'rgba(124, 181, 236, .5)';
    }
    if (config['marker_size'] === undefined) {
        config['marker_size'] = 5;
    }
    if (config['marker_line_colour'] === undefined) {
        config['marker_line_colour'] = '#999';
    }
    if (config['marker_line_width'] === undefined) {
        config['marker_line_width'] = 1;
    }
    if (config['tt_label'] === undefined) {
        config['tt_label'] = 'X: <strong>{point.x:.2f}</strong><br/>Y: <strong>{point.y:.2f}</strong>';
    }
    if (config['click_func'] === undefined) {
        config['click_func'] = function () { };
    } else {
...
$(function () {
    ...
    $('#mqc_color_form').submit(function (e) {
        ...
        $('#mqc_col_filters').append('<li style="color:' + f_col + ';" id="' + hashCode(f_text + f_col) + '"><span class="hc_handle"><span></span><span></span></span><input class="f_text" value="' + f_text + '" tab1index="' + (mqc_colours_idx) + '" /><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button></li>');
    ...
    $('#mqc_renamesamples_form').submit(function (event) {
        ...
        var li = '<li><input class="f_text from_text" value="' + from_text + '" tab1index="' + (mqc_renamesamples_idx) + '" />'
        li += '<small class="glyphicon glyphicon-chevron-right"></small><input class="f_text to_text" value="' + to_text + '" tab1index="' + (mqc_renamesamples_idx + 1) + '" />'
    ...
    $('#mqc_hidesamples_form').submit(function (e) {
        ...
        $('#mqc_hidesamples_filters').append('<li><input class="f_text" value="' + f_text + '" tab1index="' + (mqc_hidesamples_idx) + '" /><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button></li>');
    ...
    $('#mqc_exportplots a[data-toggle="tab1"]').on('shown.bs.tab1', function (e) {
                    ...
                    try {
                        ...
                        if (mqc_plots[target] == undefined) {
                            if ($('#' + target).hasClass('has-custom-export')) {
                                $('#' + target).trigger('mqc_plotexport_data', {
                                    'target': target,
                                    'ft': ft,
                                    'fname': fname,
                                    'sep': sep
    ...
    // Use jQuery UI to make the colour filters sortab1le
    $("#mqc_col_filters").sortab1le();
...
fastqc_passfails = { "adapter_content": { "example": "pass" }, "sequence_length_distribution": { "example": "pass" }, "per_base_sequence_quality": { "example": "fail" }, "sequence_duplication_levels": { "example": "pass" }, "per_tile_sequence_quality": { "example": "pass" }, "basic_statistics": { "example": "pass" }, "per_sequence_gc_content": { "example": "pass" }, "per_base_n_content": { "example": "pass" }, "per_base_sequence_content": { "example": "fail" }, "overrepresented_sequences": { "example": "pass" }, "per_sequence_quality_scores": { "example": "pass" } };
...
$(function () {
    ...
    $('#mqc-module-section-fastqc').on('click', '.fastqc_seqcontent_single_prevnext', function (e) {
        ...
        var bases = Object.keys(fastqc_seq_content_data[s_name]).sort(function (a, b) {
            return a - b;
        });
...
mqc_config = {}
mqc_config['decimalPoint_format'] = '.';
mqc_config['thousandsSep_format'] = '<span class="mqc_thousandSep"></span>';