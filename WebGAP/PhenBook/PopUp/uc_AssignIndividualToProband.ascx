...
<div class="content-body pt-1">
    <div class="card-content collapse show">
        <div class="card-bodypopup">
            <form class="form">
                <div class="form-body">
                    <h4 class="form-sectionpopup"><i class="ft-user"></i>Assign Individual <label style="padding: 4px;    background-color: #c5e9ea; border-radius: 26px; font-size:small" > Only individuals which are assigned to the samples </label></h4>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RG_Individuals" runat="server" GridLines="none" BorderWidth="0"
                        ...
                        DataSourceID="Ds_Individuals" AllowFilteringByColumn="True">
                        
                        <MasterTableView CommandItemDisplay="None" DataSourceID="Ds_Individuals" Name="Master" AutoGenerateColumns="false" ClientDataKeyNames="IndividualID,IndividualSex,IndividualFName, IndividualLName, IndividualBirthDate, IndividualStatus, LocalID" AllowFilteringByColumn="True">
                            <Columns>
                                <telerik:GridBoundColumn DataField="IndividualID"  ShowSortIcon="true" DataType="System.Int64" FilterControlAltText="Filter IndividualID column" HeaderText="Individual ID" SortExpression="IndividualID" UniqueName="IndividualID">
                                    ...
                                    <telerik:GridBoundColumn DataField="LocalID"  ShowSortIcon="true"  FilterControlAltText="Filter LocalID column" HeaderText="Local ID" SortExpression="LocalID" UniqueName="LocalID">
                                    <HeaderStyle Width="35%" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle Width="35%" VerticalAlign="Middle" HorizontalAlign="Center" />
                                      
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataType="System.int32" AllowFiltering="false" ShowFilterIcon="false" DataField="IndividualSex" UniqueName="IndividualSex" Groupable="False" EnableHeaderContextMenu="false"
                                ...
                                <telerik:GridTemplateColumn DataField="IndividualStatus" AllowFiltering="false" ShowFilterIcon="false" FilterControlAltText="Filter IndividualStatus column" EnableHeaderContextMenu="false"
                                ...
                                <telerik:GridTemplateColumn UniqueName="AddIndividual" ShowFilterIcon="false" Groupable="False" AllowFiltering="false"  EnableHeaderContextMenu="false">
    ...
    <asp:SqlDataSource ID="Ds_Individuals" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter Name="HostID" SessionField="HostID_ForFamilyMember" Type="Int32" />
