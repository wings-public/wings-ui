<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Gene_OMIM.ascx.cs" Inherits="WebGAP.PhenBook.PopUp.uc_Gene_OMIM" %>
...
<asp:SqlDataSource ID="SDS_OMIM_Unique" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
    SelectCommand="Sp_PhenBook_Gene_OMIM_Sel" SelectCommandType="StoredProcedure">
    <SelectParameters>
