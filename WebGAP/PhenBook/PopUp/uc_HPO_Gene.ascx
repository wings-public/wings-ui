<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_HPO_Gene.ascx.cs" Inherits="WebGAP.PhenBook.PopUp.uc_HPO_Gene" %>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RG_Gene_Unique" runat="server" AllowPaging="True" Height="300px"
                        ...
                        <MasterTableView Name="Master" DataSourceID="SDS_Gene_Unique">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="GeneID" FilterControlAltText="Filter GeneID column" SortExpression="GeneID" HeaderText="Gene Id" UniqueName="GeneID" DataType="System.Int32">
...
<asp:SqlDataSource ID="SDS_Gene_Unique" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
    SelectCommand="Sp_PhenBook_HPO_Gene_Sel" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:SessionParameter Name="HPOID" SessionField="PhenBook_popUp_HPO" />
    </SelectParameters>
</asp:SqlDataSource>
