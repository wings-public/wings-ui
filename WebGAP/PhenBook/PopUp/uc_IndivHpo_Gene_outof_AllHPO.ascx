<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_IndivHpo_Gene_outof_AllHPO.ascx.cs" Inherits="WebGAP.PhenBook.PopUp.uc_IndivHpo_Gene_outof_AllHPO" %>
            ...
            <form class="form">
                <div class="form-body">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RG_HPO_Unique" runat="server" AllowPaging="True" Height="300px"
                        ...
                        AutoGenerateColumns="False" Font-Size="Small" OnItemDataBound="RG_HPO_Unique_ItemDataBound"
...
<asp:SqlDataSource ID="SDS_HPO_Unique" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
    SelectCommand="Sp_PhenBook_Individual_HPOs_Gene_outof_all_Sel" SelectCommandType="StoredProcedure">
    <SelectParameters>
