<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_OMIM_HPO.ascx.cs" Inherits="WebGAP.PhenBook.PopUp.uc_OMIM_HPO" %>
...
<asp:SqlDataSource ID="SDS_OMIM_Unique" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
    SelectCommand="Sp_PhenBook_OMIM_HPO_Sel" SelectCommandType="StoredProcedure">
    <SelectParameters>
