<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_AddNewUserToGroup.ascx.cs" Inherits="WebGAP.ACL.Popup.uc_AddNewUserToGroup" %>
    ...
    <div class="card-bodypopup">
        <form class="form">
            <div class="form-body">
                   ...
                   <h4 class="form-sectionpopup"><i class="ft-user"></i>Add User to Group</h4>
                <div class="row">
                    <div class="col-6">
                        <div>
...
<asp:SqlDataSource ID="SDS_AllUsers" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>"
    SelectCommand="Sp_All_Users_Sel" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:SessionParameter Name="GroupID" SessionField="GroupID_User" Type="Int16" />
        <asp:SessionParameter SessionField="CenterID_GroupUser" Name="CenterID" Type="Int16" DefaultValue="-1" />
    </SelectParameters>
