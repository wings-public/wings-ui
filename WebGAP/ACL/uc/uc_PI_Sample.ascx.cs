...
{
    public partial class uc_PI_Sample : System.Web.UI.UserControl
    {
        #region "CnnStr"{
        ...
        protected void RG_PS_PI_PreRender(object sender, EventArgs e)
        {
           
            if (CenterIsChanged == 1 && (RG_PS_PI.MasterTableView.Items.Count > 0))
            {
                RG_PS_PI.MasterTableView.Items[0].Selected = true;
                RG_PS_Sample.Rebind();
                CenterIsChanged = 0;
            }
        }
