                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <div style="border-color: gainsboro; display: flex; flex-direction: row; justify-content: flex-start;">
                                                ...
                                                <div class="pr-0">
                                                    <telerik:RadTextBox runat="server" ID="txt_IndivdualID" Width="100%" CssClass="RTB_PhenBook_rmv_gradient" OnLoad="txt_IndivdualID_Load" Enabled="false" ></telerik:RadTextBox>
                                                </div>
                                                <div class="pr-1">
                                                <asp:Button ID="btn_AssignIndividual" runat="server" style="margin-left:0px;background-image:url('../../img/icon/icon_Add_16.png'); background-repeat: no-repeat; background-size: 20px 20px; height: 34px; background-color: #617FA6; border-color: #636b72;" Text="Assign Proband"   Width="128px" Height="40px" Enabled="false"  OnClick="btn_AssignIndividual_Click" />
...
<asp:SqlDataSource ID="DS_RG_FamilyMember" runat="server" ConnectionString="<%$ ConnectionStrings:MyDbConn %>" DeleteCommand="Sp_Family_Member_Del" DeleteCommandType="StoredProcedure" SelectCommand="Sp_FamilyMembers_sel" SelectCommandType="StoredProcedure"  OnSelected="DS_RG_FamilyMember_Selected">
    ...
    <SelectParameters>
        ...
        <asp:SessionParameter Name="HostID" SessionField="HostID" Type="Int64"  />
    </SelectParameters>
</asp:SqlDataSource>
